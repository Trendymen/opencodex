...
export const ja: Record<TKey, string> = {
  ...
  "onboarding.star.title": "OpenCodex を気に入っていただけましたか？",
  "onboarding.star.body": "OpenCodex は無料のオープンソースです。GitHub のスターは、ほかの開発者がプロジェクトを見つける助けになり、開発の支えになります。",
  "onboarding.star.cta": "GitHub でスターを付ける",
  "onboarding.star.ghHint": "サインイン済みの GitHub CLI (gh) でリポジトリにスターを付けます。クリックするまで何も行いません。",
...
"common.discard": "破棄",
  ...
  "dash.webSearchCodexSync": "保存しました。Codex の設定はまだ書き換えられていません —「モデルを同期」を実行してください。",
  ...
  "prov.removedShadowTarget": "\"{name}\" を削除しました。シャドウコール傍受の対象はまだ \"{model}\" のため、別の対象を選ぶまで補助呼び出しは失敗します。",
  ...
  "prov.disabledShadowTarget": "\"{name}\" を無効にしました。シャドウコール傍受の対象はまだ \"{model}\" のため、別の対象を選ぶか \"{name}\" を再度有効にするまで補助呼び出しは失敗します。",
  ...
  "models.subtitle": "Codex に表示するモデルを切り替えます — ネイティブ GPT パススルーとルーティングプロバイダーをプロバイダー別に表示します（ヘッダーをクリックすると折りたためます）。非表示モデルはカタログとピッカーから外れますが、正確な id で直接呼び出せます。",
  "models.delivery.title": "変更が Codex に届くまで",
  "models.delivery.chip.saved": "ここに保存済み",
  "models.delivery.chip.savedHub": "ハブに保存済み",
  "models.delivery.chip.synced": "{time} に同期",
  "models.delivery.chip.syncedUnknown": "同期の記録なし",
  "models.delivery.chip.loaded": "Codex は再起動時に読み込み",
  "models.delivery.saved.title": "このプロキシに保存済み",
  "models.delivery.saved.body": "このページで保存すると、この OpenCodex プロキシが Codex に渡すモデルカタログが書き換わります。それが Codex のモデルピッカーに出る一覧です。保存後の確認は、この段階が終わったことを示します。",
  "models.delivery.savedHub.title": "ハブに保存済み",
  "models.delivery.savedHub.body": "このマシンは共有の OpenCodex ハブに接続しているため、ここで保存するとハブのカタログが変わります。保存後の確認はハブ側に反映されたことを示し、このマシンはまだそれをダウンロードする必要があります。",
  "models.delivery.synced.title": "このマシンに同期済み",
  "models.delivery.synced.bodyAt": "このマシンがハブのカタログを最後にダウンロードしたのは {time} で、その内容を Codex が読む場所に書き込みました。この時刻が示すのはダウンロードが走ったときだけで、それより後にハブへ保存した場合、このマシンは次の同期まで前の一覧のままです。",
  "models.delivery.synced.bodyUnknown": "このマシンにはハブのカタログをダウンロードした記録がまだないため、Codex は古い一覧を読んでいる可能性があります。次の同期でダウンロードされます。",
  "models.delivery.loaded.title": "Codex が読み込み済み",
  "models.delivery.loaded.body": "Codex は起動時にカタログを読むため、すでに開いている Codex のウィンドウは古いモデル一覧のままです。OpenCodex は実行中の Codex の中を見て、どの一覧を使っているか確認できません。Codex が変更より前に起動したと分かる場合は、タブの上に再起動の案内が出ます。",
  "models.delivery.hint": "有効にしたモデルが Codex に出ないときは、このページ右上の「Codex のモデル一覧を再読み込み」を押してから、Codex を開き直してください。",
  ...
  "models.settingsPanel.title": "モデル設定",
  "models.settingsPanel.off": "オフ",
  "models.settingsPanel.attention": "要確認",
  "models.custom": "カスタム…",
  "models.customApply": "適用",
  "models.customPlaceholder": "トークン (例: 420000)",
  "models.applied": "保存しました。Codex はモデル一覧を再読み込みすると変更を表示します。",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "logs.filter.protocol.label": "プロトコル経路",
  "logs.filter.protocol.all": "すべての経路",
  "logs.filter.protocol.none": "経路データなし",
  "logs.protocol.mode.native": "ネイティブ",
  "logs.protocol.mode.translated": "変換",
  "logs.protocol.mode.legacyBridge": "レガシーブリッジ",
  "logs.protocol.mode.blocked": "ブロック",
  "logs.protocol.disposition.passthrough": "そのまま転送",
  "logs.protocol.disposition.translated": "変換",
  "logs.protocol.disposition.degraded": "劣化",
  "logs.protocol.disposition.unsupported": "破棄",
  "logs.protocol.wire.responses": "Responses",
  "logs.protocol.wire.chat": "Chat",
  "logs.protocol.wire.messages": "Messages",
  "logs.protocol.wire.other": "その他のアダプター",
  "logs.protocol.hop.ir": "IR",
  "logs.protocol.hop.internal": "Responses（内部）",
  "logs.protocol.badgeTitle": "プロトコル経路: {path}（{mode}）",
  "logs.detail.protocol.section": "プロトコル経路",
  "logs.detail.protocol.inbound": "クライアント API",
  "logs.detail.protocol.mode": "配信モード",
  "logs.detail.protocol.upstream": "アップストリーム形式",
  "logs.detail.protocol.requestPath": "リクエスト経路",
  "logs.detail.protocol.responsePath": "レスポンス経路",
  "logs.detail.protocol.reasons": "理由",
  "logs.detail.protocol.features": "機能への影響",
  "logs.detail.protocol.attempts": "試行ごとの経路",
  "logs.detail.protocol.attempt": "試行 {ordinal}",
  "logs.detail.protocol.none": "このリクエストには経路データが記録されていません。",
  ...
  "logs.detail.attempt.recovery.oauthAccount429": "OAuth アカウントのレート制限 (429)",
  "logs.detail.attempt.recovery.image413": "画像ペイロードが大きすぎます (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "不透明な推論 Blob が拒否されました",
  ...
  "logs.detail.outcome.incomplete": "未完了",
  "logs.detail.outcome.aborted": "中断",
  "logs.detail.sends.label": "アップストリーム送信",
  "logs.detail.sends.unresolved": "未確定",
  "logs.detail.attempt.recovery.unknown": "不明なリカバリ理由",
  "logs.detail.cause.label": "失敗の原因",
  "logs.detail.stage.label": "到達段階",
  "logs.detail.resend.label": "再送",
  "logs.detail.cause.transportUnsent": "アップストリームへ未送信",
  "logs.detail.cause.transportAmbiguous": "接続が切れ、処理状況は不明",
  "logs.detail.cause.upstreamDeclined": "アップストリームが開始を拒否",
  "logs.detail.cause.rateLimit": "レート制限",
  "logs.detail.cause.quotaExhausted": "クォータ枯渇",
  "logs.detail.cause.credentialRejected": "認証情報が拒否されました",
  "logs.detail.cause.policyRefusal": "コンテンツポリシーによる拒否",
  "logs.detail.cause.parameterRejected": "リクエストパラメータが拒否されました",
  "logs.detail.cause.ciphertextRefusal": "暗号化状態が拒否されました",
  "logs.detail.cause.payloadTooLarge": "ペイロードが大きすぎます",
  "logs.detail.cause.payloadRejected": "ペイロードが拒否されました",
  "logs.detail.cause.upstreamFault": "アップストリーム障害",
  "logs.detail.cause.emptyOutput": "利用可能な出力なし",
  "logs.detail.cause.clientCancelled": "クライアントがキャンセル",
  "logs.detail.cause.localRefusal": "このプロキシが拒否",
  "logs.detail.stage.preHeader": "レスポンスヘッダーなし",
  "logs.detail.stage.headersOnly": "ヘッダーのみ",
  "logs.detail.stage.protocolPrelude": "プロトコル前段",
  "logs.detail.stage.semanticOutput": "出力を配信済み",
  "logs.detail.stage.sideEffect": "副作用が発生",
  "logs.detail.stage.terminal": "応答を配信済み",
  "logs.detail.resend.permitted": "再送可能",
  "logs.detail.resend.permittedAfterRepair": "修正後に再送可能",
  "logs.detail.resend.refusedAmbiguous": "再送なし: アップストリームの状態が不明",
  "logs.detail.resend.refusedCommitted": "再送なし: 呼び出し元が既に出力を受信",
  "logs.detail.resend.refusedFutile": "再送なし: 同じ要求は再び失敗します",
  ...
  "logs.modelTooltip.wireModel": "送信モデル",
  ...
  "debug.providerText": "応答／推論テキスト（永続化）",
  "debug.usage": "使用量抽出",
  ...
  "usage.section.companion": "メニューバーとウィジェット",
  "usage.companion.title": "メニューバーとウィジェット",
  "usage.companion.description": "ここでの設定は OpenCodex デスクトップ／メニューバーアプリとウィジェットを制御します。",
  "usage.companion.installGuide": "インストールガイド",
  "usage.companion.loading": "タイムラインを読み込み中…",
  "usage.companion.timelineUnavailable": "タイムラインを利用できません",
  "usage.companion.empty": "過去 {hours} 時間に利用はありません",
  "usage.companion.chartLabel": "使用量タイムライン",
  "usage.companion.olderRecordsSkipped": "古い記録はスキップされました",
  "usage.companion.settingsUnavailable": "コンパニオン設定を利用できません",
  "usage.companion.corrupt": "コンパニオン設定ファイルが破損しています。コントロールにはデフォルト値が表示され、ファイルを置き換えるまで保存は一時停止されます。",
  "usage.companion.corruptReset": "デフォルト値に置き換える",
  "usage.companion.saved": "保存済み · {time}",
  "usage.companion.saveFailed": "保存できませんでした: {error}",
  "usage.companion.reset": "既定値に戻す",
  "usage.companion.footer": "ウィジェットには今日のリクエスト数、トークン数、コストと、ここで設定したグラフが表示され、アプリのポーリング時に更新されます。",
  "usage.companion.menuBarShows": "メニューバーに表示",
  "usage.companion.menuRequests": "リクエスト",
  "usage.companion.menuTokens": "トークン",
  "usage.companion.menuCost": "コスト",
  "usage.companion.menuQuota": "クォータ",
  "usage.companion.menuNone": "アイコンのみ",
  "usage.companion.window": "期間",
  "usage.companion.window6": "6時間",
  "usage.companion.window24": "24時間",
  "usage.companion.window72": "3日",
  "usage.companion.window168": "7日",
  "usage.companion.style": "スタイル",
  "usage.companion.styleLine": "線",
  "usage.companion.styleStacked": "積み上げ",
  "usage.companion.metric": "指標",
  "usage.companion.metricTotal": "合計",
  "usage.companion.metricInput": "入力",
  "usage.companion.metricOutput": "出力",
  "usage.companion.metricCached": "キャッシュ済み",
  "usage.companion.groupBy": "グループ化",
  "usage.companion.groupModel": "モデル",
  "usage.companion.groupAccount": "モデル + アカウント",
  "usage.companion.popoverSections": "ポップオーバーのセクション",
  "usage.companion.sectionToday": "今日",
  "usage.companion.sectionChart": "グラフ",
  "usage.companion.sectionModels": "モデル",
  "usage.companion.sectionCost": "コスト",
  "usage.companion.sectionAccounts": "アカウント",
  "usage.companion.advanced": "詳細設定",
  "usage.companion.aggregation": "集計",
  "usage.companion.aggregationSum": "合計",
  "usage.companion.aggregationAverage": "平均",
  "usage.companion.aggregationMax": "最大",
  "usage.companion.menuText": "メニューバーのテキスト",
  "usage.companion.placeholders": "プレースホルダー:",
  "usage.companion.modelsOnChart": "グラフのモデル",
  "usage.companion.connected": "メニューバーアプリ接続済み · {age}",
  "usage.companion.connectedDesktop": "デスクトップアプリ接続済み · {age}",
  "usage.companion.installTitle": "デスクトップアプリをインストール",
  "usage.companion.installOs": "オペレーティングシステム",
  "usage.companion.osMac": "macOS",
  "usage.companion.osWindows": "Windows",
  "usage.companion.osLinux": "Linux",
  "usage.companion.runningInDesktop": "OpenCodex デスクトップアプリ {version} を使用中です",
  "usage.companion.openInBrowser": "ブラウザで開く",
  "usage.companion.installMacStep1": "最新リリースから OpenCodex-<version>-macos.dmg をダウンロードし、OpenCodex.app をアプリケーションへ移動します。",
  "usage.companion.installMacStep2": "初回起動：OpenCodex.app を右クリックして「開く」を選択します（公証されるまで Gatekeeper が一度確認します）。",
  "usage.companion.installMacStep3": "アプリはこのプロキシを自動検出します。アプリを起動するとウィジェットギャラリーに表示されます。",
  "usage.companion.installWinStep1": "最新リリースから OpenCodex-<version>-windows-x64.msi をダウンロードして実行します。",
  "usage.companion.installWinStep2": "SmartScreen が警告したら「詳細情報」→「実行」を選択します（インストーラーはまだコード署名されていません）。",
  "usage.companion.installWinStep3": "OpenCodex はシステムトレイに表示され、このプロキシに接続するか、同梱のプロキシを起動します。",
  "usage.companion.installLinuxStep1": "最新リリースから OpenCodex-<version>-linux-x86_64.AppImage（または .deb）をダウンロードします。",
  "usage.companion.installLinuxStep2": "AppImage に chmod +x を実行して起動します。トレイアイコンには AppIndicator 対応デスクトップが必要です。",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "integrations.plan.refusal.supersededStore": "このクライアントは opencodex が書き込まないファイルからプロバイダーを読み込むため、この操作では読み込む内容は変わりません。",
  ...
  "codexAuth.mainHardLockEnabled": "98%保護を有効にしました。",
  "codexAuth.mainHardLockDisabled": "98%保護を無効にしました。他のアカウント制限は引き続き適用されます。",
  ...
  "codexAuth.mainHardLockBlocked": "98%保護により停止中",
  ...
  "anthropicGrant.badgeAria": "Claude の使用量リセット {count} 回分",
  "anthropicGrant.badgeErrorAria": "Claude の使用量リセットを読み取れませんでした",
  "anthropicGrant.title": "Claude の使用量リセット",
  "anthropicGrant.available": "このアカウントには使用量リセットが {count} 回分あります。",
  "anthropicGrant.desc": "リセットすると、このアカウントの Claude の 5 時間枠と週次枠がすぐに補充されます。週次枠のリセット曜日は変わりません。",
  "anthropicGrant.none": "このアカウントには使用量リセットがありません。",
  "anthropicGrant.ineligible": "このアカウントは現在、使用量リセットの対象ではありません。",
  "anthropicGrant.loadFailed": "このアカウントの使用量リセットを読み取れませんでした。",
  "anthropicGrant.loadFailedAuth": "リセットを読み取るには、この Anthropic アカウントに再度サインインしてください。",
  "anthropicGrant.retry": "再試行",
  "anthropicGrant.resetsLeft": "残り {left} / {total} 回",
  "anthropicGrant.validFrom": "有効開始 {date}",
  "anthropicGrant.expires": "失効 {date}（残り {days} 日）",
  "anthropicGrant.windowFiveHour": "5 時間枠 {percent}%",
  "anthropicGrant.windowWeekly": "週次枠 {percent}%",
  "anthropicGrant.windowOverage": "追加枠 {percent}%",
  "anthropicGrant.paused": "一時停止中",
  "anthropicGrant.notUsable": "まだ使用できません",
  "anthropicGrant.requiresLimit": "このアカウントが使用量の上限に達すると使用できます",
  "anthropicGrant.useOne": "リセットを 1 回使用",
  "anthropicGrant.confirmTitle": "今すぐ使用量の上限をリセットしますか?",
  "anthropicGrant.confirmDesc": "このアカウントの Claude 使用量枠を今すぐ補充し、リセットを 1 回分使用します。",
  "anthropicGrant.confirmWhich": "使用するリセット: {label}",
  "anthropicGrant.irreversible": "この操作は元に戻せません。",
  "anthropicGrant.redeem": "使用量の上限をリセット",
  "anthropicGrant.redeeming": "リセット中…",
  "anthropicGrant.resultReset": "使用量の上限をリセットしました。残り {count} 回分です。",
  "anthropicGrant.resultAlreadyUsed": "このリセットは既に使用されています。",
  "anthropicGrant.resultNotLimited": "このアカウントは上限に達していないため、リセットは使用されませんでした。",
  "anthropicGrant.resultCooldown": "このアカウントのリセットは現在クールダウン中です。リセットは使用されませんでした。",
  "anthropicGrant.resultIneligible": "このアカウントは対象外になりました。リセットは使用されませんでした。",
  "anthropicGrant.resultUnavailable": "現在、リセットを利用できません。リセットは使用されませんでした。",
  "anthropicGrant.resultRateLimited": "リクエストが多すぎます。リセットは使用されていません。1 分後に再試行してください。",
  "anthropicGrant.resultAuthError": "この Anthropic アカウントに再度サインインしてください。リセットは使用されませんでした。",
  "anthropicGrant.replayed": "このリセットは以前に処理済みです。再度使用されてはいません。",
  "anthropicGrant.notUsableNow": "現在、このリセットは使用できません。アカウントを再読み込みしてください。",
  "anthropicGrant.inFlight": "このリセットは処理中です。少し待ってからアカウントを再読み込みしてください。",
  "anthropicGrant.unresolvedPrior": "このリセットに対する前回の試行はまだ結果が確認できていません。新しい試行を始めず、前回の試行を再試行してください。",
  "anthropicGrant.expired": "前回の試行は期限内に結果を確認できませんでした。リセットを使用する前にアカウントを再読み込みしてください。",
  "anthropicGrant.identityMismatch": "このリセットは別のアカウントのものです。このダイアログを閉じてやり直してください。",
  "anthropicGrant.sessionRequired": "リセットを使用するには、ダッシュボードに直接ログインして開いてください。",
  "anthropicGrant.journalBusy": "リセットジャーナルが使用中か、利用できません。リセットは使用されていません。しばらくしてから再試行してください。",
  "anthropicGrant.failed": "リセットのリクエストに失敗しました。再試行する前にアカウントを確認してください。",
  "anthropicGrant.noOperationId": "このブラウザではリクエスト ID を生成できないため、ここではリセットを使用できません。",
  "anthropicGrant.unknownOutcome": "リセットの応答が間に合わなかったため、結果は不明です。再試行時には同じリクエスト ID が送られるため、2 回目のリセットは始まりません。",
  "anthropicGrant.retrySame": "同じリクエストを再試行",
  "anthropicGrant.checkResult": "アカウントを再読み込み",
  "anthropicGrant.checking": "再読み込み中…",
  ...
  "api.surface.on": "オン",
  "api.surface.off": "オフ",
  "api.surface.source.fixed": "常に提供",
  "api.surface.source.explicit": "明示的な設定",
  "api.surface.source.inherited": "Claude 設定から継承",
  "api.surface.source.invalid": "無効な値 — 閉鎖",
  "api.surface.messagesToggle": "Messages API を提供する",
  "api.surface.messagesCloseNote": "Messages をオフにすると Claude 連携もオフになるため、古い opencodex バージョンでもエンドポイントは閉じたままになります。",
  "api.surface.openClaude": "Claude 設定",
  "api.surface.toggleFailed": "Messages の設定を保存できませんでした。",
  "api.surface.toggleUnavailable": "このプロキシのバージョンではここで Messages API を変更できません。Claude ページを使ってください。",
  "api.surface.closedNote": "このエンドポイントへのリクエストは 403 で拒否されます。",
  "api.authTitle": "認証",
  ...
  "api.section.plan": "経路プレビュー",
  "api.plan.title": "リクエスト経路のプレビュー",
  "api.plan.description": "このモデルへのリクエストがプロキシ内でたどる経路を表示します。プレビューは上流に何も送信せず、費用もかかりません。",
  "api.plan.modeNote": "「ネイティブ」はリクエストの配送方法を表し、検証結果ではありません。",
  "api.plan.unavailable": "このバージョンのプロキシは経路プレビューに対応していません。",
  "api.plan.noModels": "プレビューできるモデルがまだありません。",
  "api.plan.model": "モデル",
  "api.plan.inbound": "クライアント API",
  "api.plan.features": "リクエスト機能",
  "api.plan.preview": "プレビュー",
  "api.plan.previewing": "プレビュー中…",
  "api.plan.failed": "プレビューを計算できませんでした。",
  "api.plan.overallMode": "配送",
  "api.plan.routeKind": "ルート",
  "api.plan.reasons": "理由",
  "api.plan.guaranteed": "すべての候補で保証",
  "api.plan.partial": "一部の候補のみ",
  "api.plan.policyRevision": "ポリシーリビジョン",
  "api.plan.noCandidates": "このモデルに一致するルートがありません。",
  "api.plan.ineligible": "現在のポリシーでは拒否されます",
  "api.plan.requestPath": "リクエスト経路",
  "api.plan.responsePath": "レスポンス経路",
  "api.plan.fidelity": "忠実度",
  "api.plan.none": "なし",
  "api.plan.noPath": "経路なし",
  "api.plan.noFeatures": "リクエスト機能が選択されていません。",
  "api.plan.mode.native": "ネイティブ",
  "api.plan.mode.translated": "変換",
  "api.plan.mode.legacyBridge": "レガシーブリッジ",
  "api.plan.mode.blocked": "ブロック",
  "api.plan.fidelity.preserved": "維持",
  "api.plan.fidelity.degraded": "劣化",
  "api.plan.fidelity.unknown": "不明",
  "api.plan.routeKind.direct": "直接",
  "api.plan.routeKind.combo": "コンボ",
  "api.plan.routeKind.policy": "ルーティングポリシー",
  "api.plan.routeKind.unknown": "不明なモデル",
  "api.plan.disposition.passthrough": "そのまま転送",
  "api.plan.disposition.translated": "変換",
  "api.plan.disposition.degraded": "劣化",
  "api.plan.disposition.unsupported": "破棄",
  "api.plan.disposition.unknown": "不明",
  ...
  "claudeDesktop.switchModeApply": "モードを切り替えて適用",
  "claudeDesktop.status.appliedFirstParty": "1P: Desktop の Code タブはローカルプロキシ経由",
  "claudeDesktop.mode.legend": "接続モード",
  "claudeDesktop.mode.firstParty": "1P（ファーストパーティ）",
  "claudeDesktop.mode.gateway": "ゲートウェイ（3P）",
  ...
  "claudeDesktop.firstParty.proxyStopped": "ローカルプロキシ 127.0.0.1:{port} が停止中 — OpenCodex を再起動",
  "claudeDesktop.firstParty.interceptDisabled": "設定でインターセプトプロキシが無効です（claudeCode.intercept.enabled）",
  "claudeDesktop.picker.title": "Claude Desktop ピッカー",
  "claudeDesktop.picker.hint": "専用ローカルプロキシ経由で、Desktop の Code タブのピッカーに OpenCodex モデルを表示します。",
  "claudeDesktop.picker.toggle": "Claude Desktop ピッカーを有効化",
  "claudeDesktop.picker.state.active": "ピッカーは有効です",
  "claudeDesktop.picker.state.restart": "ピッカープロファイルの適用を完了するには、Claude Desktop を完全に終了して再起動してください。",
  "claudeDesktop.picker.state.trustPending": "キーチェーンの手順を待っています",
  "claudeDesktop.picker.state.trustDeclined": "キーチェーンの信頼が拒否されました",
  "claudeDesktop.picker.state.proxyUnavailable": "ピッカープロキシが起動していません",
  "claudeDesktop.picker.state.unsupported": "この OS ではピッカーモードを利用できません",
  "claudeDesktop.picker.state.notFirstParty": "ピッカーはファーストパーティーモードでのみ利用できます",
  "claudeDesktop.picker.state.profileFailed": "ピッカープロファイルを適用できませんでした",
  "claudeDesktop.picker.models": "ピッカーで {count} モデルを利用できます",
  "claudeDesktop.picker.offlineNote": "ピッカーモードが有効な間、Claude Desktop は OpenCodex 経由でネットワークに接続します。OpenCodex が停止すると、Desktop を再起動するかピッカーモードをオフにするまでオフラインになります。",
  "claudeDesktop.firstParty.bindings.title": "Code タブのモデルバインディング",
  "claudeDesktop.firstParty.bindings.hint": "Claude Desktop は Code タブのピッカーに Anthropic の名前をそのまま表示します。ピッカーのモデルを OpenCodex のモデルにバインドすると、そのピッカー項目へのリクエストはバインド先のモデルで処理されます。ローカルプロキシ経由の Claude Code トラフィック（Desktop の Code タブと claude CLI）のみがこのバインディングを使用し、ocx claude には影響しません。バインディングは次のリクエストから適用されるため、完全に終了して開き直す必要はありません。",
  "claudeDesktop.firstParty.bindings.empty": "バインディングはまだありません — ピッカーのモデルはデフォルトのルートを使います。",
  "claudeDesktop.firstParty.bindings.pickerLabel": "ピッカーのモデル ID",
  "claudeDesktop.firstParty.bindings.pickerPlaceholder": "claude-sonnet-4-6",
  "claudeDesktop.firstParty.bindings.routeLabel": "OpenCodex モデル",
  "claudeDesktop.firstParty.bindings.routePlaceholder": "モデルを選択",
  "claudeDesktop.firstParty.bindings.add": "バインディングを追加",
  "claudeDesktop.firstParty.bindings.remove": "バインディング {id} を削除",
  "claudeDesktop.firstParty.bindings.saveFailed": "モデルバインディングを保存できませんでした",
  ...
  "cws.jev.effortsNone": "明示的な推論 effort なし",
  "cws.jev.stats.tab": "統計",
  "cws.jev.stats.range": "JEV 統計の期間",
  "cws.jev.stats.refresh": "更新",
  "cws.jev.stats.loading": "JEV 統計を読み込み中",
  "cws.jev.stats.loadFailed": "JEV 統計を読み込めませんでした。",
  "cws.jev.stats.historyIncomplete": "一部の古い JEV レコードが省略されているため、合計が不完全な場合があります。",
  "cws.jev.stats.emptyTitle": "JEV の決定はまだありません",
  "cws.jev.stats.emptyBody": "このコンボを実行すると、選択とモデルのトークン使用量が記録されます。統計対応前の決定は利用できません。",
  "cws.jev.stats.decisions": "決定",
  "cws.jev.stats.appliedAndFailOpen": "適用 {applied} · フェイルオープン {failOpen}",
  "cws.jev.stats.modelTokens": "モデルのトークン",
  "cws.jev.stats.decisionTokens": "JEV 決定トークン",
  "cws.jev.stats.measuredAttempts": "{measured}/{total} 回の試行を計測",
  "cws.jev.stats.measuredDecisions": "{measured}/{total} 件の決定で使用量を報告",
  "cws.jev.stats.successful": "成功したリクエスト {count} 件",
  "cws.jev.stats.fallbackOne": "モデルフォールバック {count} 件",
  "cws.jev.stats.fallbackMany": "モデルフォールバック {count} 件",
  "cws.jev.stats.averageLatency": "平均 JEV レイテンシ: {value}",
  "cws.jev.stats.averageConfidence": "平均信頼度: {value}",
  "cws.jev.stats.gates": "JEV 決定ゲート",
  "cws.jev.stats.model": "モデル",
  "cws.jev.stats.otherModels": "その他のモデル",
  "cws.jev.stats.picks": "選択",
  "cws.jev.stats.efforts": "推論強度",
  "cws.jev.stats.attempts": "試行",
  "cws.jev.stats.input": "入力",
  "cws.jev.stats.output": "出力",
  "cws.jev.stats.reasoning": "推論",
  "cws.jev.stats.cacheReadWrite": "キャッシュ 読/書",
  "cws.jev.stats.total": "合計",
  "cws.jev.stats.noEffort": "なし",
  "cws.jev.stats.measuredShort": "計測済み",
  "cws.jev.stats.tokenFootnote": "モデルのトークンは、再試行やフォールバックを含む実際のターゲット試行から集計されます。JEV 決定トークンは決定サービスから別に報告されます。",
  "cws.railAria": "コンボ一覧",
  ...
  "cws.strategy.jevHint": "TypeSafe JEV に適格なターゲットと互換性のある effort を選ばせます。決定できない場合は最初の適格なターゲットを使用します。",
  "cws.field.id": "コンボ ID",
  ...
  "cws.targets.jevHint": "選択できるのはこの一覧のターゲットだけです。順序はフェイルオープン先とその後のコンボのフォールバックを決めます。",
  ...
  "cws.err.invalidReasoningEfforts": "各 JEV ターゲットで、サポートされている一意の推論 effort を 1 つ以上許可してください。",
  ...
  "nav.remote": "リモートリンク",
  "nav.remoteWorkspace": "リモートワークスペース",
  "link.title": "リモートリンク",
  "link.subtitle": "SSH で別のコンピューター上の OpenCodex に接続します。",
  "link.switch": "リモート接続",
  "link.switchOffHint": "接続をオンにして、このコンピューターの役割を選びます。",
  "link.role.title": "このコンピューターの役割を選択",
  "link.role.hint": "ホームはこのコンピューターのプロバイダーを子コンピューターと共有します。子を選ぶと、このコンピューターがスタンドアロンで動作している場合にホームへ接続します。",
  "link.role.home": "ホーム",
  "link.role.homeHint": "このダッシュボードから子コンピューターを管理します。",
  "link.role.child": "子",
  "link.role.childHint": "別のコンピューターの OpenCodex 設定を使います。",
  "link.continue": "続行",
  "link.sessionRequired": "リンクを管理するにはローカルダッシュボードにログインします。",
  "link.workspaceUnavailable": "このインストールでは Remote Workspace を利用できません。",
  "link.loading": "読み込み中…",
  "link.loadFailed": "リモートリンクの状態を読み込めませんでした。",
  "link.refresh": "更新",
  "link.children": "子コンピューター",
  "link.addChild": "子を追加",
  "link.sheetTitle": "子コンピューターを追加",
  "link.candidates": "SSH ホスト",
  "link.noCandidates": "SSH ホスト候補が見つかりません。",
  "link.alias": "SSH ホスト別名",
  "link.aliasPlaceholder": "SSH 設定の別名を入力",
  "link.probe": "接続をテスト",
  "link.probing": "接続をテスト中…",
  "link.hostFingerprint": "ホストキーのフィンガープリント",
  "link.confirmFingerprint": "このホストキーを確認しました",
  "link.confirming": "確認中…",
  "link.confirm": "ホストを確認",
  "link.ocxVersion": "OpenCodex バージョン {version}",
  "link.apply": "子を接続",
  "link.applying": "接続中…",
  "link.retry": "再試行",
  "link.disconnect": "切断",
  "link.disconnectConfirm": "{alias} を切断しますか？リンクキーは失効します。",
  "link.close": "閉じる",
  "link.cancel": "キャンセル",
  "remoteLink.childDisabled": "子リンクを開始できるのはスタンドアロンランタイムだけです。",
  "remoteLink.findHome.title": "Home を探す",
  ...
  "remoteLink.restart.waiting": "子として再接続するまで待機しています…",
  "remoteLink.error.standalone_required": "子リンクを開始できるのはスタンドアロンランタイムだけです。",
  "remoteLink.error.join_tunnel_failed": "Home へのトンネルを開始できませんでした。SSH 接続を確認して再試行してください。",
  "remoteLink.error.admission_failed": "Home が新しいリンクを受け付けませんでした。Home が起動しているか確認して再試行してください。",
  "remoteLink.error.join_issue_failed": "Home がリンクを発行できませんでした。Home で OpenCodex が起動しているか確認して再試行してください。",
  "remoteLink.error.join_in_progress": "リモートリンク要求を完了できませんでした。",
  "remoteLink.error.join_rollback_failed": "接続に失敗し、ホーム上のリンクを削除できませんでした。クリーンアップを再試行するか、ホームで ocx link revoke を実行してください。",
  ...
  "remoteLink.status.connected": "接続済み",
  "remoteLink.status.reconnecting": "再接続中",
  "remoteLink.status.failed": "接続の確認が必要",
  "remoteLink.status.idle": "アイドル",
  "remoteLink.role.standalone": "スタンドアロン",
  "remoteLink.role.home": "ホーム",
  "remoteLink.role.child": "子",
  "remoteLink.direction.hub": "ホーム開始",
  "remoteLink.direction.client": "クライアント開始",
  "remoteLink.error.admission_timeout": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.compensation_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.fingerprint_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.forbidden": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.host_confirmation_expired": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.host_fingerprint_mismatch": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.host_not_confirmed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.invalid_alias": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.invalid_body": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.invalid_link_id": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.key_issue_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.key_revoke_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.link_apply_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.link_exists": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.link_not_found": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.link_remove_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.link_unavailable": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.listener_unavailable": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.probe_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.remote_connect_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.remote_disconnect_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.remote_port_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.tailscale_session_refused": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.version_probe_failed": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.error.generic": "リモートリンクのリクエストを完了できませんでした。",
  "remoteLink.reason.auth": "認証に失敗しました。",
  "remoteLink.reason.hostkey": "ホストキーを確認できませんでした。",
  "remoteLink.reason.forward": "ポート転送に失敗しました。",
  "remoteLink.reason.timeout": "接続がタイムアウトしました。",
  "remoteLink.reason.bind": "ローカルポートをバインドできませんでした。",
  "remoteLink.reason.persist": "リンク状態を保存できませんでした。",
  "remoteLink.reason.compensation_failed": "リンク後のクリーンアップに失敗しました。",
  "remoteLink.reason.staleTunnel": "古いトンネルがまだポートを使用している可能性があります。",
  "remoteLink.reason.generic": "理由：",
  "remoteLink.workspaceMoved.title": "Remote Workspace は専用ページになりました",
  "remoteLink.workspaceMoved.body": "専用の Remote Workspace ページを使用します。",
  "remoteLink.workspaceMoved.open": "Remote Workspace を開く",
  "remoteLink.forceRemove.title": "このコンピューターは {alias} に接続できませんでした",
  "remoteLink.forceRemove.body": "このコンピューターだけでリンクを削除しますか？その後 {alias} で自分で {cmd} を実行してください。",
  "remoteLink.forceRemove.confirm": "ここだけ削除",
  ...
  "quotaSummary.scrollPrev": "プロバイダーを左へスクロール",
  "quotaSummary.scrollNext": "プロバイダーを右へスクロール",
  "quotaSummary.openAccounts": "アカウント管理を開く",
  "pws.protocol.title": "アップストリームのワイヤー形式",
  "pws.protocol.note": "opencodex がこのプロバイダーと通信する API 形式です。クライアント API のオン/オフは切り替えません。それは API ページで設定します。",
  "pws.protocol.adapterLabel": "このプロバイダーが受け取るワイヤー形式",
  "pws.protocol.source": "決定元",
  "pws.protocol.source.hardPin": "opencodex がこのモデル用に固定",
  "pws.protocol.source.operator": "ユーザー設定",
  "pws.protocol.source.registry": "プロバイダーカタログ",
  "pws.protocol.source.providerDefault": "プロバイダーの既定",
  "pws.protocol.pending": "保存すると、このプロバイダーは {adapter} を受け取ります。",
  "pws.protocol.overrides": "別のワイヤー形式を使うモデル",
  "pws.protocol.noOverrides": "すべてのモデルがプロバイダーのワイヤー形式を使います。",
  "pws.protocol.overridesTruncated": "最初の {count} 件のモデルを表示しています。",
  "pws.protocol.col.model": "モデル",
