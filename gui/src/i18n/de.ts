...
export const de: Record<TKey, string> = {
  ...
  "onboarding.star.title": "Gefällt Ihnen OpenCodex?",
  "onboarding.star.body": "OpenCodex ist kostenlos und Open Source. Ein Stern auf GitHub hilft anderen Entwicklern, es zu finden, und hält das Projekt am Laufen.",
  "onboarding.star.cta": "Auf GitHub mit Stern markieren",
  "onboarding.star.ghHint": "Markiert das Repository mit Ihrer angemeldeten GitHub CLI (gh). Erst Ihr Klick löst etwas aus.",
...
"common.discard": "Verwerfen",
  ...
  "prov.removedShadowTarget": "\"{name}\" entfernt. Shadow-Call-Abfangen zielt weiterhin auf \"{model}\"; Hilfsaufrufe schlagen fehl, bis Sie ein anderes Ziel wählen.",
  ...
  "prov.disabledShadowTarget": "\"{name}\" deaktiviert. Shadow-Call-Abfangen zielt weiterhin auf \"{model}\"; Hilfsaufrufe schlagen fehl, bis Sie ein anderes Ziel wählen oder \"{name}\" wieder aktivieren.",
  ...
  "models.subtitle": "Steuere, welche Modelle Codex sieht — natives GPT-Passthrough und geroutete Anbieter, nach Anbieter gruppiert (Kopfzeile zum Einklappen anklicken). Ausgeblendete Modelle fehlen in Katalog und Auswahl, bleiben aber per genauer ID aufrufbar.",
  "models.delivery.title": "So gelangen Änderungen zu Codex",
  "models.delivery.chip.saved": "Hier gespeichert",
  "models.delivery.chip.savedHub": "Auf dem Hub gespeichert",
  "models.delivery.chip.synced": "Synchronisiert {time}",
  "models.delivery.chip.syncedUnknown": "Keine Synchronisierung erfasst",
  "models.delivery.chip.loaded": "Codex lädt sie beim Neustart",
  "models.delivery.saved.title": "In diesem Proxy gespeichert",
  "models.delivery.saved.body": "Beim Speichern auf dieser Seite wird der Modellkatalog neu geschrieben, den dieser OpenCodex-Proxy an Codex übergibt — also die Liste in der Modellauswahl von Codex. Die Bestätigung nach dem Speichern bedeutet, dass dieser Schritt abgeschlossen ist.",
  "models.delivery.savedHub.title": "Auf dem Hub gespeichert",
  "models.delivery.savedHub.body": "Dieser Rechner ist mit einem gemeinsamen OpenCodex-Hub verbunden, daher ändert das Speichern hier den Katalog des Hubs. Die Bestätigung nach dem Speichern bedeutet, dass der Hub ihn hat; dieser Rechner muss ihn noch herunterladen.",
  "models.delivery.synced.title": "Mit diesem Rechner synchronisiert",
  "models.delivery.synced.bodyAt": "Dieser Rechner hat den Hub-Katalog zuletzt am {time} heruntergeladen und dort abgelegt, wo Codex ihn liest. Der Zeitpunkt sagt nur, wann der Download lief. Wenn Sie danach auf dem Hub gespeichert haben, behält dieser Rechner die vorherige Liste bis zur nächsten Synchronisierung.",
  "models.delivery.synced.bodyUnknown": "Für diesen Rechner ist noch kein Download des Hub-Katalogs erfasst, daher liest Codex möglicherweise noch eine ältere Liste. Die nächste Synchronisierung lädt ihn herunter.",
  "models.delivery.loaded.title": "Von Codex geladen",
  "models.delivery.loaded.body": "Codex liest den Katalog beim Start, daher behält ein bereits geöffnetes Codex-Fenster seine alte Modellliste. OpenCodex kann nicht in ein laufendes Codex hineinsehen, um zu prüfen, welche Liste es verwendet. Wenn erkennbar ist, dass Codex vor Ihrer Änderung gestartet wurde, erscheint über den Registerkarten ein Hinweis zum Neustart.",
  "models.delivery.hint": "Wenn ein Modell, das Sie eingeschaltet haben, in Codex nicht erscheint, klicken Sie oben rechts auf dieser Seite auf Codex-Modelle neu laden und öffnen Sie Codex danach erneut.",
  ...
  "models.settingsPanel.title": "Modelleinstellungen",
  "models.settingsPanel.off": "aus",
  "models.settingsPanel.attention": "Handlungsbedarf",
  ...
  "models.applied": "Gespeichert. Codex zeigt die Änderung, nachdem es die Modellliste neu geladen hat.",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "logs.filter.protocol.label": "Protokollpfad",
  "logs.filter.protocol.all": "Alle Pfade",
  "logs.filter.protocol.none": "Keine Pfaddaten",
  "logs.protocol.mode.native": "Nativ",
  "logs.protocol.mode.translated": "Übersetzt",
  "logs.protocol.mode.legacyBridge": "Legacy-Brücke",
  "logs.protocol.mode.blocked": "Blockiert",
  "logs.protocol.disposition.passthrough": "Durchgereicht",
  "logs.protocol.disposition.translated": "Übersetzt",
  "logs.protocol.disposition.degraded": "Eingeschränkt",
  "logs.protocol.disposition.unsupported": "Verworfen",
  "logs.protocol.wire.responses": "Responses",
  "logs.protocol.wire.chat": "Chat",
  "logs.protocol.wire.messages": "Messages",
  "logs.protocol.wire.other": "Anderer Adapter",
  "logs.protocol.hop.ir": "IR",
  "logs.protocol.hop.internal": "Responses (intern)",
  "logs.protocol.badgeTitle": "Protokollpfad: {path} ({mode})",
  "logs.detail.protocol.section": "Protokollpfad",
  "logs.detail.protocol.inbound": "Client-API",
  "logs.detail.protocol.mode": "Zustellmodus",
  "logs.detail.protocol.upstream": "Upstream-Format",
  "logs.detail.protocol.requestPath": "Anfragepfad",
  "logs.detail.protocol.responsePath": "Antwortpfad",
  "logs.detail.protocol.reasons": "Gründe",
  "logs.detail.protocol.features": "Auswirkungen auf Funktionen",
  "logs.detail.protocol.attempts": "Pfade der Versuche",
  "logs.detail.protocol.attempt": "Versuch {ordinal}",
  "logs.detail.protocol.none": "Für diese Anfrage wurden keine Pfaddaten aufgezeichnet.",
  ...
  "logs.detail.attempt.recovery.oauthAccount429": "OAuth-Konto ratenbegrenzt (429)",
  "logs.detail.attempt.recovery.image413": "Bildnutzlast zu groß (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "Opaker Reasoning-Blob abgelehnt",
  ...
  "logs.modelTooltip.wireModel": "gesendetes Modell",
  ...
  "debug.providerText": "Antwort-/Reasoning-Text (gespeichert)",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "codexAuth.mainHardLockEnabled": "98-%-Schutz ist aktiviert.",
  "codexAuth.mainHardLockDisabled": "98-%-Schutz ist deaktiviert. Andere Kontolimits gelten weiterhin.",
  ...
  "codexAuth.mainHardLockBlocked": "Durch 98-%-Schutz gesperrt",
  ...
  "anthropicGrant.badgeAria": "{count} Claude-Nutzungslimit-Rücksetzungen",
  "anthropicGrant.badgeErrorAria": "Claude-Nutzungslimit-Rücksetzungen konnten nicht gelesen werden",
  "anthropicGrant.title": "Claude-Nutzungslimit-Rücksetzungen",
  "anthropicGrant.available": "Für dieses Konto sind {count} Nutzungslimit-Rücksetzungen verfügbar.",
  "anthropicGrant.desc": "Eine Rücksetzung füllt die 5-Stunden- und Wochenlimits dieses Claude-Kontos sofort wieder auf. Der Tag der wöchentlichen Rücksetzung bleibt gleich.",
  "anthropicGrant.none": "Für dieses Konto sind keine Nutzungslimit-Rücksetzungen verfügbar.",
  "anthropicGrant.ineligible": "Dieses Konto ist derzeit nicht für Nutzungslimit-Rücksetzungen berechtigt.",
  "anthropicGrant.loadFailed": "Die Nutzungslimit-Rücksetzungen für dieses Konto konnten nicht gelesen werden.",
  "anthropicGrant.loadFailedAuth": "Melde dich erneut bei diesem Anthropic-Konto an, um seine Rücksetzungen zu lesen.",
  "anthropicGrant.retry": "Erneut versuchen",
  "anthropicGrant.resetsLeft": "Noch {left} von {total} übrig",
  "anthropicGrant.validFrom": "Gültig ab {date}",
  "anthropicGrant.expires": "Läuft am {date} ab (noch {days} Tage)",
  "anthropicGrant.windowFiveHour": "5 Stunden: {percent}%",
  "anthropicGrant.windowWeekly": "Wöchentlich: {percent}%",
  "anthropicGrant.windowOverage": "Zusätzlich: {percent}%",
  "anthropicGrant.paused": "Pausiert",
  "anthropicGrant.notUsable": "Noch nicht verwendbar",
  "anthropicGrant.requiresLimit": "Verwendbar, sobald dieses Konto ein Limit erreicht",
  "anthropicGrant.useOne": "1 Rücksetzung verwenden",
  "anthropicGrant.confirmTitle": "Nutzungslimits jetzt zurücksetzen?",
  "anthropicGrant.confirmDesc": "Damit werden die Claude-Nutzungslimits dieses Kontos jetzt aufgefüllt und eine Rücksetzung verbraucht.",
  "anthropicGrant.confirmWhich": "Verwendet: {label}",
  "anthropicGrant.irreversible": "Diese Aktion kann nicht rückgängig gemacht werden.",
  "anthropicGrant.redeem": "Limits zurücksetzen",
  "anthropicGrant.redeeming": "Wird zurückgesetzt…",
  "anthropicGrant.resultReset": "Limits zurückgesetzt. Noch {count} Rücksetzungen übrig.",
  "anthropicGrant.resultAlreadyUsed": "Diese Rücksetzung wurde bereits verwendet.",
  "anthropicGrant.resultNotLimited": "Dieses Konto hat noch kein Limit erreicht. Es wurde nichts verbraucht.",
  "anthropicGrant.resultCooldown": "Für dieses Konto gilt gerade eine Wartezeit zwischen Rücksetzungen. Es wurde nichts verbraucht.",
  "anthropicGrant.resultIneligible": "Dieses Konto ist nicht mehr berechtigt. Es wurde nichts verbraucht.",
  "anthropicGrant.resultUnavailable": "Rücksetzungen sind derzeit nicht verfügbar. Es wurde nichts verbraucht.",
  "anthropicGrant.resultRateLimited": "Zu viele Anfragen. Es wurde nichts verbraucht; versuche es in einer Minute erneut.",
  "anthropicGrant.resultAuthError": "Melde dich erneut bei diesem Anthropic-Konto an. Es wurde nichts verbraucht.",
  "anthropicGrant.replayed": "Diese Rücksetzung wurde bereits zuvor abgeschlossen. Es wurde nicht erneut etwas verbraucht.",
  "anthropicGrant.notUsableNow": "Diese Rücksetzung kann gerade nicht verwendet werden. Lies das Konto erneut.",
  "anthropicGrant.inFlight": "Diese Rücksetzung wird noch verarbeitet. Warte einen Moment und lies das Konto dann erneut.",
  "anthropicGrant.unresolvedPrior": "Ein früherer Versuch mit dieser Rücksetzung ist noch nicht bestätigt. Wiederhole diesen Versuch, statt einen neuen zu starten.",
  "anthropicGrant.expired": "Der frühere Versuch konnte nicht rechtzeitig bestätigt werden. Lies das Konto erneut, bevor du eine Rücksetzung verwendest.",
  "anthropicGrant.identityMismatch": "Diese Rücksetzung gehört zu einem anderen Konto. Schließe diesen Dialog und starte erneut.",
  "anthropicGrant.sessionRequired": "Öffne das Dashboard über seine eigene Anmeldung, um Rücksetzungen zu verwenden.",
  "anthropicGrant.journalBusy": "Das Rücksetzungsjournal ist ausgelastet oder nicht verfügbar. Es wurde nichts verbraucht; versuche es in einem Moment erneut.",
  "anthropicGrant.failed": "Die Rücksetzungsanfrage ist fehlgeschlagen. Prüfe das Konto, bevor du es erneut versuchst.",
  "anthropicGrant.noOperationId": "Dieser Browser kann keine Anfrage-ID erzeugen. Rücksetzungen sind hier daher deaktiviert.",
  "anthropicGrant.unknownOutcome": "Die Rücksetzung hat nicht rechtzeitig geantwortet, daher ist ihr Ergebnis unbekannt. Ein erneuter Versuch sendet dieselbe Anfrage-ID und kann keine zweite Rücksetzung starten.",
  "anthropicGrant.retrySame": "Dieselbe Anfrage erneut versuchen",
  "anthropicGrant.checkResult": "Konto erneut lesen",
  "anthropicGrant.checking": "Wird erneut gelesen…",
  ...
  "api.surface.on": "An",
  "api.surface.off": "Aus",
  "api.surface.source.fixed": "Immer bereitgestellt",
  "api.surface.source.explicit": "Explizite Einstellung",
  "api.surface.source.inherited": "Von den Claude-Einstellungen übernommen",
  "api.surface.source.invalid": "Ungültiger Wert — geschlossen",
  "api.surface.messagesToggle": "Messages API bereitstellen",
  "api.surface.messagesCloseNote": "Wenn Messages ausgeschaltet wird, wird auch die Claude-Integration ausgeschaltet, damit eine ältere opencodex-Version den Endpunkt ebenfalls geschlossen hält.",
  "api.surface.openClaude": "Claude-Einstellungen",
  "api.surface.toggleFailed": "Die Messages-Einstellung konnte nicht gespeichert werden.",
  "api.surface.toggleUnavailable": "Diese Proxy-Version kann die Messages API hier nicht ändern. Nutze stattdessen die Claude-Seite.",
  "api.surface.closedNote": "Anfragen an diesen Endpunkt werden mit 403 abgelehnt.",
  ...
  "api.section.plan": "Pfadvorschau",
  "api.plan.title": "Vorschau des Anfragepfads",
  "api.plan.description": "Zeigt den Pfad, den eine Anfrage für dieses Modell durch den Proxy nehmen würde. Eine Vorschau sendet nichts an den Anbieter und kostet nichts.",
  "api.plan.modeNote": "„Nativ“ beschreibt, wie eine Anfrage zugestellt wird. Es ist kein Prüfergebnis.",
  "api.plan.unavailable": "Diese Proxy-Version bietet keine Pfadvorschau.",
  "api.plan.noModels": "Noch keine Modelle für eine Vorschau.",
  "api.plan.model": "Modell",
  "api.plan.inbound": "Client-API",
  "api.plan.features": "Anfragefunktionen",
  "api.plan.preview": "Vorschau",
  "api.plan.previewing": "Vorschau läuft…",
  "api.plan.failed": "Die Vorschau konnte nicht berechnet werden.",
  "api.plan.overallMode": "Zustellung",
  "api.plan.routeKind": "Route",
  "api.plan.reasons": "Gründe",
  "api.plan.guaranteed": "Von allen Kandidaten garantiert",
  "api.plan.partial": "Nur bei einigen Kandidaten",
  "api.plan.policyRevision": "Richtlinienrevision",
  "api.plan.noCandidates": "Keine Route passt zu diesem Modell.",
  "api.plan.ineligible": "Unter der aktuellen Richtlinie abgelehnt",
  "api.plan.requestPath": "Anfragepfad",
  "api.plan.responsePath": "Antwortpfad",
  "api.plan.fidelity": "Treue",
  "api.plan.none": "Keine",
  "api.plan.noPath": "Kein Pfad",
  "api.plan.noFeatures": "Keine Anfragefunktionen ausgewählt.",
  "api.plan.mode.native": "Nativ",
  "api.plan.mode.translated": "Übersetzt",
  "api.plan.mode.legacyBridge": "Legacy-Brücke",
  "api.plan.mode.blocked": "Blockiert",
  "api.plan.fidelity.preserved": "Erhalten",
  "api.plan.fidelity.degraded": "Eingeschränkt",
  "api.plan.fidelity.unknown": "Unbekannt",
  "api.plan.routeKind.direct": "Direkt",
  "api.plan.routeKind.combo": "Combo",
  "api.plan.routeKind.policy": "Routing-Richtlinie",
  "api.plan.routeKind.unknown": "Unbekanntes Modell",
  "api.plan.disposition.passthrough": "Durchgereicht",
  "api.plan.disposition.translated": "Übersetzt",
  "api.plan.disposition.degraded": "Eingeschränkt",
  "api.plan.disposition.unsupported": "Verworfen",
  "api.plan.disposition.unknown": "Unbekannt",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.jev.create": "JEV Auto erstellen",
  ...
  "cws.jev.effortsNone": "Kein expliziter Reasoning-Aufwand",
  "cws.jev.stats.tab": "Statistik",
  "cws.jev.stats.range": "Zeitraum der JEV-Statistik",
  "cws.jev.stats.refresh": "Aktualisieren",
  "cws.jev.stats.loading": "JEV-Statistik wird geladen",
  "cws.jev.stats.loadFailed": "Die JEV-Statistik konnte nicht geladen werden.",
  "cws.jev.stats.historyIncomplete": "Einige ältere JEV-Einträge wurden ausgelassen; die Summen können unvollständig sein.",
  "cws.jev.stats.emptyTitle": "Noch keine JEV-Entscheidungen",
  "cws.jev.stats.emptyBody": "Führen Sie diese Combo aus, um Auswahl und Modell-Tokenverbrauch aufzuzeichnen. Entscheidungen vor Installation der Statistikunterstützung sind nicht verfügbar.",
  "cws.jev.stats.decisions": "Entscheidungen",
  "cws.jev.stats.appliedAndFailOpen": "{applied} angewendet · {failOpen} Fail-open",
  "cws.jev.stats.modelTokens": "Modell-Tokens",
  "cws.jev.stats.decisionTokens": "JEV-Entscheidungs-Tokens",
  "cws.jev.stats.measuredAttempts": "{measured}/{total} Versuche gemessen",
  "cws.jev.stats.measuredDecisions": "{measured}/{total} Entscheidungen mit Nutzungsdaten",
  "cws.jev.stats.successful": "{count} erfolgreiche Anfragen",
  "cws.jev.stats.fallbackOne": "{count} Modell-Fallback",
  "cws.jev.stats.fallbackMany": "{count} Modell-Fallbacks",
  "cws.jev.stats.averageLatency": "Mittlere JEV-Latenz: {value}",
  "cws.jev.stats.averageConfidence": "Mittlere Konfidenz: {value}",
  "cws.jev.stats.gates": "JEV-Entscheidungstore",
  "cws.jev.stats.model": "Modell",
  "cws.jev.stats.otherModels": "Andere Modelle",
  "cws.jev.stats.picks": "Auswahlen",
  "cws.jev.stats.efforts": "Aufwände",
  "cws.jev.stats.attempts": "Versuche",
  "cws.jev.stats.input": "Eingabe",
  "cws.jev.stats.output": "Ausgabe",
  "cws.jev.stats.reasoning": "Reasoning",
  "cws.jev.stats.cacheReadWrite": "Cache L/S",
  "cws.jev.stats.total": "Gesamt",
  "cws.jev.stats.noEffort": "keiner",
  "cws.jev.stats.measuredShort": "gemessen",
  "cws.jev.stats.tokenFootnote": "Modell-Tokens stammen aus physischen Zielversuchen einschließlich Wiederholungen und Fallbacks. JEV-Entscheidungs-Tokens werden vom Entscheidungsdienst separat gemeldet.",
  ...
  "cws.strategy.jevHint": "TypeSafe JEV wählt ein geeignetes Ziel und einen kompatiblen Aufwand. Ist keine Entscheidung verfügbar, wird das erste geeignete Ziel verwendet.",
  ...
  "cws.targets.jevHint": "Nur diese Ziele können ausgewählt werden. Die Reihenfolge bestimmt das Fail-open-Ziel und den späteren Combo-Fallback.",
  ...
  "cws.err.invalidReasoningEfforts": "Jedes JEV-Ziel muss mindestens einen eindeutigen unterstützten Reasoning-Aufwand zulassen.",
  ...
  "claudeDesktop.picker.title": "Claude-Desktop-Auswahl",
  "claudeDesktop.picker.hint": "OpenCodex-Modelle über den dedizierten lokalen Proxy in der Code-Tab-Auswahl von Desktop anzeigen.",
  "claudeDesktop.picker.toggle": "Claude-Desktop-Auswahl aktivieren",
  "claudeDesktop.picker.state.active": "Auswahl ist aktiv",
  "claudeDesktop.picker.state.restart": "Claude Desktop vollständig beenden und erneut öffnen, um das Auswahlprofil anzuwenden.",
  "claudeDesktop.picker.state.trustPending": "Warten auf den Schlüsselbundschritt",
  "claudeDesktop.picker.state.trustDeclined": "Schlüsselbundvertrauen wurde abgelehnt",
  "claudeDesktop.picker.state.proxyUnavailable": "Auswahlproxy läuft nicht",
  "claudeDesktop.picker.state.unsupported": "Auswahlmodus wird auf diesem Betriebssystem nicht unterstützt",
  "claudeDesktop.picker.state.notFirstParty": "Die Auswahl ist nur im First-Party-Modus verfügbar",
  "claudeDesktop.picker.state.profileFailed": "Das Auswahlprofil konnte nicht angewendet werden",
  "claudeDesktop.picker.models": "{count} Modelle in der Auswahl verfügbar",
  "claudeDesktop.picker.offlineNote": "Bei aktiviertem Auswahlmodus erreicht Claude Desktop das Netzwerk über OpenCodex. Wenn OpenCodex stoppt, ist Desktop offline, bis es neu gestartet oder der Auswahlmodus deaktiviert wird.",
  "claudeDesktop.firstParty.bindings.title": "Modellbindungen des Code-Tabs",
  ...
  "claudeDesktop.firstParty.bindings.empty": "Noch keine Bindungen — Auswahlmodelle folgen ihrer Standardroute.",
  "claudeDesktop.firstParty.bindings.pickerLabel": "Modell-ID der Auswahl",
  "claudeDesktop.firstParty.bindings.pickerPlaceholder": "claude-sonnet-4-6",
  "claudeDesktop.firstParty.bindings.routeLabel": "OpenCodex-Modell",
  "claudeDesktop.firstParty.bindings.routePlaceholder": "Modell wählen",
  "claudeDesktop.firstParty.bindings.add": "Bindung hinzufügen",
  "claudeDesktop.firstParty.bindings.remove": "Bindung {id} entfernen",
  "claudeDesktop.firstParty.bindings.saveFailed": "Modellbindungen konnten nicht gespeichert werden",
  ...
  "nav.remoteWorkspace": "Remote-Arbeitsbereich",
  "link.title": "Remote-Link",
  "link.subtitle": "Verbinden Sie einen weiteren OpenCodex-Computer über SSH.",
  "link.switch": "Remote-Verbindung",
  "link.switchOffHint": "Aktivieren Sie die Verbindung, um die Rolle dieses Computers auszuwählen.",
  "link.role.title": "Rolle dieses Computers auswählen",
  "link.role.hint": "Home teilt die Provider dieses Computers mit Child-Computern. Als Child verbindet sich dieser Computer mit einem Home, wenn er eigenständig läuft.",
  "link.role.home": "Zuhause",
  "link.role.homeHint": "Verwalten Sie Kindercomputer über dieses Dashboard.",
  "link.role.child": "Kind",
  "link.role.childHint": "Nutzen Sie die OpenCodex-Einrichtung eines anderen Computers.",
  "link.continue": "Weiter",
  "link.sessionRequired": "Melden Sie sich bei der lokalen Dashboard-Sitzung an, um Verbindungen zu verwalten.",
  "link.workspaceUnavailable": "Remote Workspace ist auf dieser Installation nicht verfügbar.",
  "link.loading": "Wird geladen…",
  "link.loadFailed": "Status der Remote-Verbindung konnte nicht geladen werden.",
  "link.refresh": "Aktualisieren",
  "link.children": "Kindercomputer",
  "link.addChild": "Kind hinzufügen",
  "link.sheetTitle": "Kindercomputer hinzufügen",
  "link.candidates": "SSH-Hosts",
  "link.noCandidates": "Keine SSH-Hostkandidaten gefunden.",
  "link.alias": "SSH-Host-Alias",
  "link.aliasPlaceholder": "Alias aus der SSH-Konfiguration eingeben",
  "link.probe": "Verbindung testen",
  "link.probing": "Verbindung wird getestet…",
  "link.hostFingerprint": "Hostschlüssel-Fingerabdruck",
  "link.confirmFingerprint": "Ich erkenne diesen Hostschlüssel",
  "link.confirming": "Wird bestätigt…",
  "link.confirm": "Host bestätigen",
  "link.ocxVersion": "OpenCodex-Version {version}",
  "link.apply": "Kind verbinden",
  "link.applying": "Verbindung wird hergestellt…",
  "link.retry": "Erneut versuchen",
  "link.disconnect": "Trennen",
  "link.disconnectConfirm": "{alias} trennen? Der Verbindungsschlüssel wird widerrufen.",
  "link.close": "Schließen",
  "link.cancel": "Abbrechen",
  "remoteLink.childDisabled": "Kind-Verbindungen können nur von einer eigenständigen Laufzeit gestartet werden.",
  "remoteLink.findHome.title": "Home suchen",
  ...
  "remoteLink.restart.waiting": "Warten auf die erneute Verbindung als Kind …",
  "remoteLink.error.standalone_required": "Kind-Verbindungen können nur von einer eigenständigen Laufzeit gestartet werden.",
  "remoteLink.error.join_tunnel_failed": "Der Tunnel zu Home konnte nicht gestartet werden. Prüfen Sie den SSH-Zugriff und versuchen Sie es erneut.",
  "remoteLink.error.admission_failed": "Home hat die neue Verbindung nicht angenommen. Prüfen Sie, ob Home läuft, und versuchen Sie es erneut.",
  "remoteLink.error.join_issue_failed": "Home konnte keinen Link ausstellen. Prüfen Sie, ob OpenCodex auf Home läuft, und versuchen Sie es erneut.",
  ...
  "link.noChildren": "Keine Kindercomputer verbunden.",
  "remoteLink.status.connecting": "Verbindung wird hergestellt",
  "remoteLink.status.connected": "Verbunden",
  "remoteLink.status.reconnecting": "Wird neu verbunden",
  "remoteLink.status.failed": "Verbindung benötigt Aufmerksamkeit",
  "remoteLink.status.idle": "Leerlauf",
  "remoteLink.role.standalone": "Eigenständig",
  "remoteLink.role.home": "Zuhause",
  "remoteLink.role.child": "Kind",
  "remoteLink.direction.hub": "Vom Hub gestartet",
  "remoteLink.direction.client": "Vom Client gestartet",
  "remoteLink.error.admission_timeout": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.compensation_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.fingerprint_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.forbidden": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.host_confirmation_expired": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.host_fingerprint_mismatch": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.host_not_confirmed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.invalid_alias": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.invalid_body": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.invalid_link_id": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.key_issue_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.key_revoke_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.link_apply_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.link_exists": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.link_not_found": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.link_remove_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.link_unavailable": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.listener_unavailable": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.probe_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.remote_connect_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.remote_disconnect_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.remote_port_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.tailscale_session_refused": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.version_probe_failed": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.error.generic": "Die Remote-Link-Anfrage konnte nicht abgeschlossen werden.",
  "remoteLink.reason.auth": "Die Authentifizierung ist fehlgeschlagen.",
  "remoteLink.reason.hostkey": "Der Hostschlüssel konnte nicht verifiziert werden.",
  "remoteLink.reason.forward": "Die Portweiterleitung ist fehlgeschlagen.",
  "remoteLink.reason.timeout": "Die Verbindung ist wegen einer Zeitüberschreitung fehlgeschlagen.",
  "remoteLink.reason.bind": "Der lokale Port konnte nicht gebunden werden.",
  "remoteLink.reason.persist": "Der Linkstatus konnte nicht gespeichert werden.",
  "remoteLink.reason.compensation_failed": "Die Bereinigung nach dem Verknüpfen ist fehlgeschlagen.",
  "remoteLink.reason.staleTunnel": "Ein veralteter Tunnel könnte den Port noch belegen.",
  "remoteLink.reason.generic": "Grund:",
  "remoteLink.workspaceMoved.title": "Remote Workspace hat jetzt eine eigene Seite",
  "remoteLink.workspaceMoved.body": "Verwenden Sie die separate Remote-Workspace-Seite.",
  "remoteLink.workspaceMoved.open": "Remote Workspace öffnen",
  "remoteLink.forceRemove.title": "Dieses Gerät konnte {alias} nicht erreichen",
  "remoteLink.forceRemove.body": "Link nur auf diesem Gerät entfernen? Führen Sie danach selbst {cmd} auf {alias} aus.",
  "remoteLink.forceRemove.confirm": "Nur hier entfernen",
  ...
  "quotaSummary.scrollPrev": "Anbieter nach links scrollen",
  "quotaSummary.scrollNext": "Anbieter nach rechts scrollen",
  "quotaSummary.openAccounts": "Kontoverwaltung öffnen",
  "pws.protocol.title": "Upstream-Protokoll",
  "pws.protocol.note": "Das API-Format, das opencodex mit diesem Anbieter spricht. Es schaltet keine Client-API ein oder aus; das steuert die API-Seite.",
  "pws.protocol.adapterLabel": "Upstream-Protokoll, das dieser Anbieter empfängt",
  "pws.protocol.source": "Festgelegt durch",
  "pws.protocol.source.hardPin": "Von opencodex für dieses Modell festgelegt",
  "pws.protocol.source.operator": "Ihre Konfiguration",
  "pws.protocol.source.registry": "Anbieterkatalog",
  "pws.protocol.source.providerDefault": "Anbieter-Standard",
  "pws.protocol.pending": "Nach dem Speichern empfängt dieser Anbieter {adapter}.",
  "pws.protocol.overrides": "Modelle mit anderem Protokoll",
  "pws.protocol.noOverrides": "Alle Modelle verwenden das Protokoll des Anbieters.",
  "pws.protocol.overridesTruncated": "Die ersten {count} Modelle werden angezeigt.",
  "pws.protocol.col.model": "Modell",
