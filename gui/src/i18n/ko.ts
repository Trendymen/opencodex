...
export const ko: Record<TKey, string> = {
  ...
  "onboarding.star.title": "OpenCodex, 마음에 드시나요?",
  "onboarding.star.body": "OpenCodex는 무료 오픈소스입니다. GitHub 스타 하나가 다른 개발자들이 프로젝트를 발견하고, 프로젝트가 계속 이어지는 데 큰 힘이 됩니다.",
  "onboarding.star.cta": "GitHub에서 스타 누르기",
  "onboarding.star.ghHint": "로그인된 GitHub CLI(gh)로 저장소에 스타를 누릅니다. 버튼을 누르기 전에는 아무것도 하지 않습니다.",
...
"common.discard": "버리기",
  ...
  "dash.webSearchOff": "끔",
  "dash.webSearchCodexSync": "저장했습니다. Codex 설정이 아직 다시 작성되지 않았습니다 — “모델 동기화”를 실행하세요.",
  ...
  "prov.removedShadowTarget": "\"{name}\"을(를) 삭제했습니다. 쉐도우 호출 가로채기가 아직 \"{model}\"을(를) 가리키므로, 다른 대상을 고를 때까지 보조 호출이 실패합니다.",
  ...
  "prov.disabledShadowTarget": "\"{name}\"을(를) 비활성화했습니다. 쉐도우 호출 가로채기가 아직 \"{model}\"을(를) 가리키므로, 다른 대상을 고르거나 \"{name}\"을(를) 다시 켤 때까지 보조 호출이 실패합니다.",
  ...
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다.",
  "models.delivery.title": "Codex 반영 과정",
  "models.delivery.chip.saved": "여기 저장됨",
  "models.delivery.chip.savedHub": "허브에 저장됨",
  "models.delivery.chip.synced": "{time} 동기화",
  "models.delivery.chip.syncedUnknown": "동기화 기록 없음",
  "models.delivery.chip.loaded": "Codex 재시작 시 반영",
  "models.delivery.saved.title": "이 프록시에 저장",
  "models.delivery.saved.body": "이 화면에서 저장하면 OpenCodex 프록시가 Codex에 넘겨주는 모델 카탈로그가 바뀝니다. Codex 모델 선택기에 뜨는 목록이 바로 이 카탈로그입니다. 저장 후 확인 알림이 뜨면 이 단계는 끝난 것입니다.",
  "models.delivery.savedHub.title": "허브에 저장",
  "models.delivery.savedHub.body": "이 컴퓨터는 공유 OpenCodex 허브에 연결돼 있어서, 여기서 저장하면 허브의 카탈로그가 바뀝니다. 확인 알림은 허브에 반영됐다는 뜻이고, 이 컴퓨터는 아직 그 목록을 내려받아야 합니다.",
  "models.delivery.synced.title": "이 컴퓨터로 동기화",
  "models.delivery.synced.bodyAt": "이 컴퓨터는 {time}에 허브 카탈로그를 마지막으로 내려받아 Codex가 읽는 위치에 저장했습니다. 이 시각은 내려받은 때만 알려줍니다. 그 뒤에 허브에서 저장했다면 다음 동기화 전까지는 이전 목록이 남아 있습니다.",
  "models.delivery.synced.bodyUnknown": "이 컴퓨터가 허브 카탈로그를 내려받은 기록이 아직 없어서, Codex가 이전 목록을 읽고 있을 수 있습니다. 다음 동기화 때 내려받습니다.",
  "models.delivery.loaded.title": "Codex에 반영",
  "models.delivery.loaded.body": "Codex는 시작할 때 카탈로그를 읽습니다. 그래서 이미 열려 있던 Codex 창은 이전 모델 목록을 그대로 씁니다. OpenCodex는 실행 중인 Codex 안을 들여다볼 수 없어서 어떤 목록을 쓰는지 확인하지 못합니다. 다만 Codex가 변경 전에 시작됐다는 걸 알 수 있으면 탭 위에 재시작 안내가 뜹니다.",
  "models.delivery.hint": "켠 모델이 Codex에 보이지 않으면 이 화면 오른쪽 위의 'Codex 모델 목록 새로고침' 버튼을 누른 뒤 Codex를 다시 여세요.",
  ...
  "models.settingsPanel.title": "모델 설정",
  "models.settingsPanel.off": "끔",
  "models.settingsPanel.attention": "확인 필요",
  "models.custom": "직접 입력…",
  ...
  "models.applied": "저장했습니다. Codex는 모델 목록을 다시 읽은 뒤에 반영합니다.",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "logs.filter.protocol.label": "프로토콜 경로",
  "logs.filter.protocol.all": "모든 경로",
  "logs.filter.protocol.none": "경로 데이터 없음",
  "logs.protocol.mode.native": "네이티브",
  "logs.protocol.mode.translated": "변환됨",
  "logs.protocol.mode.legacyBridge": "레거시 브리지",
  "logs.protocol.mode.blocked": "차단됨",
  "logs.protocol.disposition.passthrough": "그대로 전달",
  "logs.protocol.disposition.translated": "변환됨",
  "logs.protocol.disposition.degraded": "저하됨",
  "logs.protocol.disposition.unsupported": "삭제됨",
  "logs.protocol.wire.responses": "Responses",
  "logs.protocol.wire.chat": "Chat",
  "logs.protocol.wire.messages": "Messages",
  "logs.protocol.wire.other": "기타 어댑터",
  "logs.protocol.hop.ir": "IR",
  "logs.protocol.hop.internal": "Responses (내부)",
  "logs.protocol.badgeTitle": "프로토콜 경로: {path} ({mode})",
  "logs.detail.protocol.section": "프로토콜 경로",
  "logs.detail.protocol.inbound": "클라이언트 API",
  "logs.detail.protocol.mode": "전달 모드",
  "logs.detail.protocol.upstream": "업스트림 형식",
  "logs.detail.protocol.requestPath": "요청 경로",
  "logs.detail.protocol.responsePath": "응답 경로",
  "logs.detail.protocol.reasons": "사유",
  "logs.detail.protocol.features": "기능 영향",
  "logs.detail.protocol.attempts": "시도별 경로",
  "logs.detail.protocol.attempt": "시도 {ordinal}",
  "logs.detail.protocol.none": "이 요청에는 기록된 경로 데이터가 없습니다.",
  ...
  "logs.detail.attempt.recovery.oauthAccount429": "OAuth 계정 요청 한도 초과 (429)",
  "logs.detail.attempt.recovery.image413": "이미지 페이로드가 너무 큼 (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "불투명 추론 Blob 거부됨",
  ...
  "logs.detail.outcome.incomplete": "미완료",
  "logs.detail.outcome.aborted": "중단됨",
  "logs.detail.sends.label": "업스트림 전송",
  "logs.detail.sends.unresolved": "미확인",
  "logs.detail.attempt.recovery.unknown": "알 수 없는 복구 사유",
  "logs.detail.cause.label": "실패 원인",
  "logs.detail.stage.label": "도달 지점",
  "logs.detail.resend.label": "재전송",
  "logs.detail.cause.transportUnsent": "업스트림으로 전송되지 않음",
  "logs.detail.cause.transportAmbiguous": "연결이 끊겨 업스트림 처리 여부 불명",
  "logs.detail.cause.upstreamDeclined": "업스트림이 시작을 거부함",
  "logs.detail.cause.rateLimit": "요청 한도 초과",
  "logs.detail.cause.quotaExhausted": "할당량 소진",
  "logs.detail.cause.credentialRejected": "자격 증명 거부됨",
  "logs.detail.cause.policyRefusal": "콘텐츠 정책으로 거부됨",
  "logs.detail.cause.parameterRejected": "요청 파라미터 거부됨",
  "logs.detail.cause.ciphertextRefusal": "암호화된 상태 거부됨",
  "logs.detail.cause.payloadTooLarge": "페이로드가 너무 큼",
  "logs.detail.cause.payloadRejected": "페이로드 거부됨",
  "logs.detail.cause.upstreamFault": "업스트림 장애",
  "logs.detail.cause.emptyOutput": "사용할 수 있는 출력 없음",
  "logs.detail.cause.clientCancelled": "클라이언트가 취소함",
  "logs.detail.cause.localRefusal": "이 프록시가 거부함",
  "logs.detail.stage.preHeader": "응답 헤더 없음",
  "logs.detail.stage.headersOnly": "헤더까지",
  "logs.detail.stage.protocolPrelude": "프로토콜 프리앰블",
  "logs.detail.stage.semanticOutput": "출력 전달됨",
  "logs.detail.stage.sideEffect": "부수 효과 발생",
  "logs.detail.stage.terminal": "응답 전달 완료",
  "logs.detail.resend.permitted": "재전송 가능",
  "logs.detail.resend.permittedAfterRepair": "수정 후 재전송 가능",
  "logs.detail.resend.refusedAmbiguous": "재전송 안 함: 업스트림 처리 여부 불명",
  "logs.detail.resend.refusedCommitted": "재전송 안 함: 이미 출력이 전달됨",
  "logs.detail.resend.refusedFutile": "재전송 안 함: 같은 요청은 다시 실패함",
  ...
  "logs.modelTooltip.wireModel": "전송 모델",
  ...
  "debug.providerText": "응답/추론 텍스트 (저장됨)",
  ...
  "usage.section.companion": "메뉴 막대 및 위젯",
  "usage.companion.title": "메뉴 막대 및 위젯",
  "usage.companion.description": "이 설정은 OpenCodex 데스크톱/메뉴 막대 앱과 위젯을 제어합니다.",
  "usage.companion.installGuide": "설치 안내",
  "usage.companion.loading": "타임라인 로드 중…",
  "usage.companion.timelineUnavailable": "타임라인을 사용할 수 없습니다",
  "usage.companion.empty": "지난 {hours}시간 동안 사용량이 없습니다",
  "usage.companion.chartLabel": "사용량 타임라인",
  "usage.companion.olderRecordsSkipped": "오래된 기록을 건너뛰었습니다",
  "usage.companion.settingsUnavailable": "컴패니언 설정을 사용할 수 없습니다",
  "usage.companion.corrupt": "컴패니언 설정 파일이 손상되었습니다. 컨트롤에는 기본값이 표시되며 파일을 교체할 때까지 저장이 일시 중지됩니다.",
  "usage.companion.corruptReset": "기본값으로 교체",
  "usage.companion.saved": "저장됨 · {time}",
  "usage.companion.saveFailed": "저장하지 못했습니다: {error}",
  "usage.companion.reset": "기본값으로 재설정",
  "usage.companion.footer": "위젯에는 오늘의 요청, 토큰, 비용과 여기에서 구성한 차트가 표시되며 앱이 폴링할 때 새로 고쳐집니다.",
  "usage.companion.menuBarShows": "메뉴 막대 표시",
  "usage.companion.menuRequests": "요청",
  "usage.companion.menuTokens": "토큰",
  "usage.companion.menuCost": "비용",
  "usage.companion.menuQuota": "할당량",
  "usage.companion.menuNone": "아이콘만",
  "usage.companion.window": "기간",
  "usage.companion.window6": "6시간",
  "usage.companion.window24": "24시간",
  "usage.companion.window72": "3일",
  "usage.companion.window168": "7일",
  "usage.companion.style": "스타일",
  "usage.companion.styleLine": "선",
  "usage.companion.styleStacked": "누적",
  "usage.companion.metric": "지표",
  "usage.companion.metricTotal": "합계",
  "usage.companion.metricInput": "입력",
  "usage.companion.metricOutput": "출력",
  "usage.companion.metricCached": "캐시됨",
  "usage.companion.groupBy": "그룹 기준",
  "usage.companion.groupModel": "모델",
  "usage.companion.groupAccount": "모델 + 계정",
  "usage.companion.popoverSections": "팝오버 섹션",
  "usage.companion.sectionToday": "오늘",
  "usage.companion.sectionChart": "차트",
  "usage.companion.sectionModels": "모델",
  "usage.companion.sectionCost": "비용",
  "usage.companion.sectionAccounts": "계정",
  "usage.companion.advanced": "고급",
  "usage.companion.aggregation": "집계",
  "usage.companion.aggregationSum": "합계",
  "usage.companion.aggregationAverage": "평균",
  "usage.companion.aggregationMax": "최대",
  "usage.companion.menuText": "메뉴 막대 텍스트",
  "usage.companion.placeholders": "자리표시자:",
  "usage.companion.modelsOnChart": "차트의 모델",
  "usage.companion.connected": "메뉴 막대 앱 연결됨 · {age}",
  "usage.companion.connectedDesktop": "데스크톱 앱 연결됨 · {age}",
  "usage.companion.installTitle": "데스크톱 앱 설치",
  "usage.companion.installOs": "운영 체제",
  "usage.companion.osMac": "macOS",
  "usage.companion.osWindows": "Windows",
  "usage.companion.osLinux": "Linux",
  "usage.companion.runningInDesktop": "OpenCodex 데스크톱 앱 {version}에서 실행 중입니다",
  "usage.companion.openInBrowser": "브라우저에서 열기",
  "usage.companion.installMacStep1": "최신 릴리스에서 OpenCodex-<version>-macos.dmg를 다운로드하고 OpenCodex.app을 응용 프로그램으로 드래그하세요.",
  "usage.companion.installMacStep2": "첫 실행: OpenCodex.app을 마우스 오른쪽 버튼으로 클릭하고 열기를 선택하세요(공증될 때까지 Gatekeeper가 한 번 확인합니다).",
  "usage.companion.installMacStep3": "앱이 이 프록시를 자동으로 찾으며, 앱을 실행하면 위젯 갤러리에 위젯이 표시됩니다.",
  "usage.companion.installWinStep1": "최신 릴리스에서 OpenCodex-<version>-windows-x64.msi를 다운로드하고 실행하세요.",
  "usage.companion.installWinStep2": "SmartScreen 경고가 표시되면 추가 정보 → 실행을 선택하세요(설치 프로그램은 아직 코드 서명되지 않았습니다).",
  "usage.companion.installWinStep3": "OpenCodex가 시스템 트레이에 나타나 이 프록시에 연결하거나 번들 프록시를 시작합니다.",
  "usage.companion.installLinuxStep1": "최신 릴리스에서 OpenCodex-<version>-linux-x86_64.AppImage(또는 .deb)를 다운로드하세요.",
  "usage.companion.installLinuxStep2": "AppImage에 chmod +x를 실행하고 시작하세요. 트레이 아이콘에는 AppIndicator를 지원하는 데스크톱이 필요합니다.",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "integrations.plan.refusal.supersededStore": "이 클라이언트는 opencodex가 쓰지 않는 파일에서 프로바이더를 읽으므로, 이 작업으로는 클라이언트가 불러오는 내용이 달라지지 않습니다.",
  ...
  "codexAuth.mainHardLockEnabled": "98% 보호 설정을 켰습니다.",
  "codexAuth.mainHardLockDisabled": "98% 보호 설정을 껐습니다. 다른 계정 제한은 그대로 적용됩니다.",
  ...
  "codexAuth.mainHardLockBlocked": "98% 보호로 차단 중",
  "codexAuth.mainHardLockUnknown": "보호 켜짐 · 사용량 확인 필요",
  "codexAuth.mainHardLockMonitoring": "98% 보호 켜짐",
  ...
  "anthropicGrant.badgeAria": "Claude 사용량 리셋 {count}개",
  "anthropicGrant.badgeErrorAria": "Claude 사용량 리셋을 읽지 못했습니다",
  "anthropicGrant.title": "Claude 사용량 리셋",
  "anthropicGrant.available": "이 계정에 사용량 리셋이 {count}개 있습니다.",
  "anthropicGrant.desc": "리셋 1개로 이 계정의 Claude 5시간·주간 한도를 바로 다시 채웁니다. 주간 리셋 요일은 바뀌지 않습니다.",
  "anthropicGrant.none": "이 계정에는 사용량 리셋이 없습니다.",
  "anthropicGrant.ineligible": "지금은 이 계정에서 사용량 리셋을 쓸 수 없습니다.",
  "anthropicGrant.loadFailed": "이 계정의 사용량 리셋을 읽지 못했습니다.",
  "anthropicGrant.loadFailedAuth": "리셋을 읽으려면 이 Anthropic 계정에 다시 로그인하세요.",
  "anthropicGrant.retry": "다시 시도",
  "anthropicGrant.resetsLeft": "{total}개 중 {left}개 남음",
  "anthropicGrant.validFrom": "유효 시작 {date}",
  "anthropicGrant.expires": "만료 {date} ({days}일 남음)",
  "anthropicGrant.windowFiveHour": "5시간 {percent}%",
  "anthropicGrant.windowWeekly": "주간 {percent}%",
  "anthropicGrant.windowOverage": "추가 사용량 {percent}%",
  "anthropicGrant.paused": "일시 중지됨",
  "anthropicGrant.notUsable": "아직 사용할 수 없음",
  "anthropicGrant.requiresLimit": "한도에 도달하면 사용할 수 있음",
  "anthropicGrant.useOne": "리셋 1개 사용",
  "anthropicGrant.confirmTitle": "지금 사용량 한도를 리셋할까요?",
  "anthropicGrant.confirmDesc": "이 계정의 Claude 사용량 한도를 지금 다시 채우고 리셋 1개를 사용합니다.",
  "anthropicGrant.confirmWhich": "사용할 리셋: {label}",
  "anthropicGrant.irreversible": "이 작업은 되돌릴 수 없습니다.",
  "anthropicGrant.redeem": "한도 리셋",
  "anthropicGrant.redeeming": "리셋하는 중…",
  "anthropicGrant.resultReset": "한도를 리셋했습니다. 남은 리셋: {count}개.",
  "anthropicGrant.resultAlreadyUsed": "이 리셋은 이미 사용되었습니다.",
  "anthropicGrant.resultNotLimited": "이 계정은 한도에 도달하지 않아 리셋이 사용되지 않았습니다.",
  "anthropicGrant.resultCooldown": "이 계정은 리셋 대기 시간 중입니다. 리셋은 사용되지 않았습니다.",
  "anthropicGrant.resultIneligible": "이 계정은 더 이상 리셋 대상이 아닙니다. 리셋은 사용되지 않았습니다.",
  "anthropicGrant.resultUnavailable": "지금은 리셋을 쓸 수 없습니다. 리셋은 사용되지 않았습니다.",
  "anthropicGrant.resultRateLimited": "요청이 너무 많습니다. 리셋은 사용되지 않았습니다. 잠시 후 다시 시도하세요.",
  "anthropicGrant.resultAuthError": "이 Anthropic 계정에 다시 로그인하세요. 리셋은 사용되지 않았습니다.",
  "anthropicGrant.replayed": "이 리셋은 이전에 이미 처리되었습니다. 다시 사용되지 않았습니다.",
  "anthropicGrant.notUsableNow": "지금은 이 리셋을 쓸 수 없습니다. 계정을 다시 읽어 보세요.",
  "anthropicGrant.inFlight": "이 리셋은 아직 처리 중입니다. 잠시 기다린 뒤 계정을 다시 읽으세요.",
  "anthropicGrant.unresolvedPrior": "이 리셋의 이전 시도가 아직 확인되지 않았습니다. 새로 시작하지 말고 그 시도를 다시 보내세요.",
  "anthropicGrant.expired": "이전 시도를 제때 확인하지 못했습니다. 리셋을 쓰기 전에 계정을 다시 읽으세요.",
  "anthropicGrant.identityMismatch": "이 리셋은 다른 계정에 속합니다. 이 대화상자를 닫고 다시 시작하세요.",
  "anthropicGrant.sessionRequired": "리셋은 대시보드에 직접 로그인한 세션에서만 사용할 수 있습니다.",
  "anthropicGrant.journalBusy": "리셋 저널이 사용 중이거나 열리지 않습니다. 리셋은 사용되지 않았습니다. 잠시 후 다시 시도하세요.",
  "anthropicGrant.failed": "리셋 요청이 실패했습니다. 다시 시도하기 전에 계정을 확인하세요.",
  "anthropicGrant.noOperationId": "이 브라우저는 요청 ID를 만들 수 없어 여기서는 리셋을 쓸 수 없습니다.",
  "anthropicGrant.unknownOutcome": "리셋 요청이 제때 응답하지 않아 결과를 알 수 없습니다. 다시 시도하면 같은 요청 ID를 보내므로 리셋이 두 번 쓰이지 않습니다.",
  "anthropicGrant.retrySame": "같은 요청 다시 보내기",
  "anthropicGrant.checkResult": "계정 다시 읽기",
  "anthropicGrant.checking": "다시 읽는 중…",
  ...
  "api.surface.on": "켜짐",
  "api.surface.off": "꺼짐",
  "api.surface.source.fixed": "항상 제공",
  "api.surface.source.explicit": "명시적 설정",
  "api.surface.source.inherited": "Claude 설정에서 상속",
  "api.surface.source.invalid": "잘못된 값 — 닫힘",
  "api.surface.messagesToggle": "Messages API 제공",
  "api.surface.messagesCloseNote": "Messages를 끄면 Claude 연동도 함께 꺼지므로, 이전 opencodex 버전에서도 엔드포인트가 닫힌 채로 유지됩니다.",
  "api.surface.openClaude": "Claude 설정",
  "api.surface.toggleFailed": "Messages 설정을 저장하지 못했습니다.",
  "api.surface.toggleUnavailable": "이 프록시 버전에서는 여기서 Messages API를 바꿀 수 없습니다. Claude 페이지를 사용하세요.",
  "api.surface.closedNote": "이 엔드포인트로 오는 요청은 403으로 거부됩니다.",
  ...
  "api.section.plan": "경로 미리보기",
  "api.plan.title": "요청 경로 미리보기",
  "api.plan.description": "이 모델로 보낸 요청이 프록시 안에서 거칠 경로를 보여 줍니다. 미리보기는 업스트림에 아무것도 보내지 않으며 비용도 들지 않습니다.",
  "api.plan.modeNote": "'네이티브'는 요청이 전달되는 방식을 뜻하며 검증 결과가 아닙니다.",
  "api.plan.unavailable": "이 프록시 버전은 경로 미리보기를 지원하지 않습니다.",
  "api.plan.noModels": "아직 미리 볼 모델이 없습니다.",
  "api.plan.model": "모델",
  "api.plan.inbound": "클라이언트 API",
  "api.plan.features": "요청 기능",
  "api.plan.preview": "미리보기",
  "api.plan.previewing": "미리보는 중…",
  "api.plan.failed": "미리보기를 계산하지 못했습니다.",
  "api.plan.overallMode": "전달 방식",
  "api.plan.routeKind": "라우트",
  "api.plan.reasons": "사유",
  "api.plan.guaranteed": "모든 후보가 보장",
  "api.plan.partial": "일부 후보만",
  "api.plan.policyRevision": "정책 리비전",
  "api.plan.noCandidates": "이 모델과 일치하는 라우트가 없습니다.",
  "api.plan.ineligible": "현재 정책에서 거부됨",
  "api.plan.requestPath": "요청 경로",
  "api.plan.responsePath": "응답 경로",
  "api.plan.fidelity": "충실도",
  "api.plan.none": "없음",
  "api.plan.noPath": "경로 없음",
  "api.plan.noFeatures": "선택한 요청 기능이 없습니다.",
  "api.plan.mode.native": "네이티브",
  "api.plan.mode.translated": "변환",
  "api.plan.mode.legacyBridge": "레거시 브리지",
  "api.plan.mode.blocked": "차단",
  "api.plan.fidelity.preserved": "유지",
  "api.plan.fidelity.degraded": "저하",
  "api.plan.fidelity.unknown": "알 수 없음",
  "api.plan.routeKind.direct": "직접",
  "api.plan.routeKind.combo": "콤보",
  "api.plan.routeKind.policy": "라우팅 정책",
  "api.plan.routeKind.unknown": "알 수 없는 모델",
  "api.plan.disposition.passthrough": "그대로 전달",
  "api.plan.disposition.translated": "변환",
  "api.plan.disposition.degraded": "저하",
  "api.plan.disposition.unsupported": "삭제",
  "api.plan.disposition.unknown": "알 수 없음",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.jev.effortsNone": "명시적 추론 노력 없음",
  "cws.jev.stats.tab": "통계",
  "cws.jev.stats.range": "JEV 통계 기간",
  "cws.jev.stats.refresh": "새로 고침",
  "cws.jev.stats.loading": "JEV 통계 불러오는 중",
  "cws.jev.stats.loadFailed": "JEV 통계를 불러올 수 없습니다.",
  "cws.jev.stats.historyIncomplete": "일부 이전 JEV 기록이 제외되어 합계가 불완전할 수 있습니다.",
  "cws.jev.stats.emptyTitle": "아직 JEV 결정이 없습니다",
  "cws.jev.stats.emptyBody": "이 콤보를 실행하면 선택과 모델 토큰 사용량이 기록됩니다. 통계 지원 이전의 결정은 사용할 수 없습니다.",
  "cws.jev.stats.decisions": "결정",
  "cws.jev.stats.appliedAndFailOpen": "적용 {applied} · 페일오픈 {failOpen}",
  "cws.jev.stats.modelTokens": "모델 토큰",
  "cws.jev.stats.decisionTokens": "JEV 결정 토큰",
  "cws.jev.stats.measuredAttempts": "시도 {measured}/{total}회 측정",
  "cws.jev.stats.measuredDecisions": "결정 {measured}/{total}건이 사용량 보고",
  "cws.jev.stats.successful": "성공한 요청 {count}건",
  "cws.jev.stats.fallbackOne": "모델 폴백 {count}건",
  "cws.jev.stats.fallbackMany": "모델 폴백 {count}건",
  "cws.jev.stats.averageLatency": "평균 JEV 지연 시간: {value}",
  "cws.jev.stats.averageConfidence": "평균 신뢰도: {value}",
  "cws.jev.stats.gates": "JEV 결정 게이트",
  "cws.jev.stats.model": "모델",
  "cws.jev.stats.otherModels": "기타 모델",
  "cws.jev.stats.picks": "선택",
  "cws.jev.stats.efforts": "추론 강도",
  "cws.jev.stats.attempts": "시도",
  "cws.jev.stats.input": "입력",
  "cws.jev.stats.output": "출력",
  "cws.jev.stats.reasoning": "추론",
  "cws.jev.stats.cacheReadWrite": "캐시 읽기/쓰기",
  "cws.jev.stats.total": "합계",
  "cws.jev.stats.noEffort": "없음",
  "cws.jev.stats.measuredShort": "측정됨",
  "cws.jev.stats.tokenFootnote": "모델 토큰은 재시도와 폴백을 포함한 실제 대상 시도에서 집계됩니다. JEV 결정 토큰은 결정 서비스가 별도로 보고합니다.",
  "cws.railAria": "콤보 목록",
  ...
  "cws.strategy.jevHint": "TypeSafe JEV가 적합한 대상과 호환되는 추론 노력을 선택합니다. 결정을 사용할 수 없으면 첫 번째 적합한 대상을 사용합니다.",
  "cws.field.id": "콤보 ID",
  ...
  "cws.targets.jevHint": "이 대상만 선택할 수 있습니다. 순서가 장애 시 기본 대상과 이후 콤보 대체 경로를 결정합니다.",
  ...
  "cws.err.invalidReasoningEfforts": "각 JEV 대상은 지원되는 고유한 추론 노력 하나 이상을 허용해야 합니다.",
  ...
  "claudeDesktop.switchModeApply": "모드 전환 후 적용",
  "claudeDesktop.status.appliedFirstParty": "1P: Desktop Code 탭이 로컬 프록시를 통해 연결됨",
  "claudeDesktop.mode.legend": "연결 모드",
  "claudeDesktop.mode.firstParty": "1P (퍼스트파티)",
  "claudeDesktop.mode.gateway": "게이트웨이 (3P)",
  ...
  "claude.firstParty.notApplied": "CLI 1P가 켜져 있지만 프록시 설정이 적용되지 않았습니다. 일반 claude를 사용하기 전에 Claude 설정을 확인하세요.",
  ...
  "claude.firstParty.routingOff": "현재 설정에서는 opencodex가 Claude 인터셉트를 제공하지 않습니다. Claude 라우팅이나 인터셉트가 꺼져 있거나, 이 기기가 다른 opencodex 허브의 클라이언트일 수 있습니다. 그래서 이 설정은 요청을 처리하지 않는 프록시를 가리킵니다. 이 기기에서 다시 켜거나 1P를 꺼서 설정을 제거하세요.",
  "claude.firstParty.disabled": "opencodex에서 Claude 라우팅이 꺼져 있습니다. 로컬 프록시는 opencodex를 다시 시작하기 전까지 요청을 바꾸지 않고 전달합니다. 재시작 후에도 설정이 남아 있으면 일반 claude는 연결할 수 없습니다. 설정을 지우려면 1P를 끄세요.",
  "claude.firstParty.foreign": "~/.claude/settings.json이 opencodex 프록시를 가리키지만 opencodex가 관리하지 않는 인증서를 신뢰하고 있어 요청이 실패합니다. 파일에서 HTTPS_PROXY / NODE_EXTRA_CA_CERTS를 직접 수정하세요.",
  "claude.firstParty.local": "~/.claude/settings.json을 통해 Claude Code가 127.0.0.1의 로컬 프록시를 사용하고 있습니다. opencodex가 소유한 프록시인지는 확인할 수 없습니다. 더 이상 사용하지 않는다면 해당 파일에서 HTTPS_PROXY를 지우세요.",
  "claude.firstParty.unknown": "opencodex가 ~/.claude/settings.json이 아직 자체 프록시를 가리키는지 확인하지 못했습니다.",
  ...
  "claudeDesktop.firstParty.proxyStopped": "로컬 프록시 127.0.0.1:{port}가 실행 중이 아님 — OpenCodex 재시작",
  "claudeDesktop.firstParty.interceptDisabled": "설정에서 인터셉트 프록시가 비활성화됨 (claudeCode.intercept.enabled)",
  "claudeDesktop.picker.title": "Claude Desktop 선택기",
  "claudeDesktop.picker.hint": "전용 로컬 프록시를 통해 Desktop Code 탭 선택기에 OpenCodex 모델을 표시합니다.",
  "claudeDesktop.picker.toggle": "Claude Desktop 선택기 켜기",
  "claudeDesktop.picker.state.active": "선택기가 활성화됨",
  "claudeDesktop.picker.state.restart": "선택기 프로필 적용을 마치려면 Claude Desktop을 완전히 종료한 뒤 다시 열어주세요.",
  "claudeDesktop.picker.state.trustPending": "키체인 단계 대기 중",
  "claudeDesktop.picker.state.trustDeclined": "키체인 신뢰가 거부됨",
  "claudeDesktop.picker.state.proxyUnavailable": "선택기 프록시가 실행 중이 아님",
  "claudeDesktop.picker.state.unsupported": "이 운영체제에서는 선택기 모드를 지원하지 않음",
  "claudeDesktop.picker.state.notFirstParty": "선택기는 퍼스트파티 모드에서만 사용할 수 있음",
  "claudeDesktop.picker.state.profileFailed": "선택기 프로필을 적용하지 못함",
  "claudeDesktop.picker.models": "선택기에서 {count}개 모델 사용 가능",
  "claudeDesktop.picker.offlineNote": "선택기 모드가 켜져 있는 동안 Claude Desktop은 OpenCodex를 통해 네트워크에 연결됩니다. OpenCodex가 중지되면 Desktop을 다시 시작하거나 선택기 모드를 끌 때까지 오프라인 상태가 됩니다.",
  "claudeDesktop.firstParty.bindings.title": "Code 탭 모델 바인딩",
  "claudeDesktop.firstParty.bindings.hint": "Claude Desktop은 Code 탭 선택기에 Anthropic 이름을 그대로 유지합니다. 선택기 모델을 OpenCodex 모델에 바인딩하면 해당 선택 항목의 요청이 바인딩된 모델로 처리됩니다. 로컬 프록시를 통과하는 Claude Code 트래픽(Desktop Code 탭과 claude CLI)만 이 바인딩을 사용하며 ocx claude에는 영향이 없습니다. 바인딩은 다음 요청부터 적용되므로 완전히 종료 후 다시 열 필요가 없습니다.",
  "claudeDesktop.firstParty.bindings.empty": "아직 바인딩이 없습니다 — 선택기 모델은 기본 경로를 따릅니다.",
  "claudeDesktop.firstParty.bindings.pickerLabel": "선택기 모델 ID",
  "claudeDesktop.firstParty.bindings.pickerPlaceholder": "claude-sonnet-4-6",
  "claudeDesktop.firstParty.bindings.routeLabel": "OpenCodex 모델",
  "claudeDesktop.firstParty.bindings.routePlaceholder": "모델 선택",
  "claudeDesktop.firstParty.bindings.add": "바인딩 추가",
  "claudeDesktop.firstParty.bindings.remove": "바인딩 {id} 제거",
  "claudeDesktop.firstParty.bindings.saveFailed": "모델 바인딩을 저장하지 못했습니다",
  ...
  "nav.remote": "원격 연결",
  "nav.remoteWorkspace": "원격 워크스페이스",
  "link.title": "원격 연결",
  "link.subtitle": "SSH로 다른 OpenCodex 컴퓨터에 연결합니다.",
  "link.switch": "원격 연결",
  "link.switchOffHint": "연결을 켜고 이 컴퓨터의 역할을 선택하세요.",
  "link.role.title": "이 컴퓨터의 역할 선택",
  "link.role.hint": "홈은 이 컴퓨터의 프로바이더를 자식 컴퓨터와 나눠 씁니다. 자식은 이 컴퓨터를 다른 홈에 연결하며, 이 컴퓨터가 독립형으로 실행 중일 때만 고를 수 있습니다.",
  "link.role.home": "홈",
  "link.role.homeHint": "이 대시보드에서 자식 컴퓨터를 관리합니다.",
  "link.role.child": "자식",
  "link.role.childHint": "다른 컴퓨터의 OpenCodex 설정을 사용합니다.",
  "link.continue": "계속",
  "link.sessionRequired": "연결을 관리하려면 로컬 대시보드 세션에 로그인하세요.",
  "link.workspaceUnavailable": "이 설치에서는 원격 워크스페이스를 사용할 수 없습니다.",
  "link.loading": "불러오는 중…",
  "link.loadFailed": "원격 연결 상태를 불러오지 못했습니다.",
  "link.refresh": "새로고침",
  "link.children": "자식 컴퓨터",
  "link.addChild": "자식 추가",
  "link.sheetTitle": "자식 컴퓨터 추가",
  "link.candidates": "SSH 호스트",
  "link.noCandidates": "SSH 호스트 후보를 찾지 못했습니다.",
  "link.alias": "SSH 호스트 별칭",
  "link.aliasPlaceholder": "SSH 설정의 별칭을 입력하세요",
  "link.probe": "연결 테스트",
  "link.probing": "연결 테스트 중…",
  "link.hostFingerprint": "호스트 키 지문",
  "link.confirmFingerprint": "이 호스트 키를 확인했습니다",
  "link.confirming": "확인 중…",
  "link.confirm": "호스트 확인",
  "link.ocxVersion": "OpenCodex 버전 {version}",
  "link.apply": "자식 연결",
  "link.applying": "연결 중…",
  "link.retry": "다시 시도",
  "link.disconnect": "연결 해제",
  "link.disconnectConfirm": "{alias}의 연결을 해제할까요? 연결 키가 폐기됩니다.",
  "link.close": "닫기",
  "link.cancel": "취소",
  "remoteLink.childDisabled": "자식 링크는 독립형 런타임에서만 시작할 수 있습니다.",
  "remoteLink.findHome.title": "홈 찾기",
  ...
  "remoteLink.restart.waiting": "자식으로 다시 연결되기를 기다리는 중…",
  "remoteLink.error.standalone_required": "자식 링크는 독립형 런타임에서만 시작할 수 있습니다.",
  "remoteLink.error.join_tunnel_failed": "홈으로 가는 터널을 시작하지 못했습니다. SSH 연결을 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.admission_failed": "홈이 새 링크를 수락하지 않았습니다. 홈이 실행 중인지 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.join_issue_failed": "홈에서 링크를 발급하지 못했습니다. 홈에서 OpenCodex가 실행 중인지 확인한 뒤 다시 시도하세요.",
  "remoteLink.error.join_in_progress": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.join_rollback_failed": "연결에 실패했고 홈의 링크를 삭제하지 못했습니다. 정리를 다시 시도하거나 홈에서 ocx link revoke를 실행하세요.",
  ...
  "remoteLink.status.connected": "연결됨",
  "remoteLink.status.reconnecting": "재연결 중",
  "remoteLink.status.failed": "연결 확인 필요",
  "remoteLink.status.idle": "유휴",
  "remoteLink.role.standalone": "독립형",
  "remoteLink.role.home": "홈",
  "remoteLink.role.child": "자식",
  "remoteLink.direction.hub": "Hub 시작",
  "remoteLink.direction.client": "클라이언트 시작",
  "remoteLink.error.admission_timeout": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.compensation_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.fingerprint_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.forbidden": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.host_confirmation_expired": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.host_fingerprint_mismatch": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.host_not_confirmed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.invalid_alias": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.invalid_body": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.invalid_link_id": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.key_issue_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.key_revoke_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.link_apply_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.link_exists": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.link_not_found": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.link_remove_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.link_unavailable": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.listener_unavailable": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.probe_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.remote_connect_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.remote_disconnect_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.remote_port_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.tailscale_session_refused": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.version_probe_failed": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.error.generic": "원격 연결 요청을 완료하지 못했습니다.",
  "remoteLink.reason.auth": "인증에 실패했습니다.",
  "remoteLink.reason.hostkey": "호스트 키를 확인하지 못했습니다.",
  "remoteLink.reason.forward": "포트 전달에 실패했습니다.",
  "remoteLink.reason.timeout": "연결 시간이 초과되었습니다.",
  "remoteLink.reason.bind": "로컬 포트에 바인딩하지 못했습니다.",
  "remoteLink.reason.persist": "링크 상태를 저장하지 못했습니다.",
  "remoteLink.reason.compensation_failed": "링크 연결 후 정리에 실패했습니다.",
  "remoteLink.reason.staleTunnel": "오래된 터널이 포트를 아직 사용 중일 수 있습니다.",
  "remoteLink.reason.generic": "이유:",
  "remoteLink.workspaceMoved.title": "원격 워크스페이스가 별도 페이지로 이동했습니다",
  "remoteLink.workspaceMoved.body": "별도의 원격 워크스페이스 페이지를 사용하세요.",
  "remoteLink.workspaceMoved.open": "원격 워크스페이스 열기",
  "remoteLink.forceRemove.title": "이 컴퓨터가 {alias}에 연결하지 못했습니다",
  "remoteLink.forceRemove.body": "이 컴퓨터에서만 링크를 지울까요? 그 후 {alias}에서 직접 {cmd}를 실행하세요.",
  "remoteLink.forceRemove.confirm": "여기에서만 삭제",
  ...
  "quotaSummary.scrollPrev": "프로바이더 목록 왼쪽으로",
  "quotaSummary.scrollNext": "프로바이더 목록 오른쪽으로",
  "quotaSummary.openAccounts": "계정 관리 열기",
  "pws.protocol.title": "업스트림 와이어",
  "pws.protocol.note": "opencodex가 이 프로바이더에 보내는 API 형식입니다. 클라이언트 API를 켜거나 끄지 않으며, 그 설정은 API 페이지에 있습니다.",
  "pws.protocol.adapterLabel": "이 프로바이더가 받는 업스트림 와이어",
  "pws.protocol.source": "결정 주체",
  "pws.protocol.source.hardPin": "opencodex가 이 모델에 고정",
  "pws.protocol.source.operator": "사용자 설정",
  "pws.protocol.source.registry": "프로바이더 카탈로그",
  "pws.protocol.source.providerDefault": "프로바이더 기본값",
  "pws.protocol.pending": "저장하면 이 프로바이더는 {adapter}를 받습니다.",
  "pws.protocol.overrides": "다른 와이어를 쓰는 모델",
  "pws.protocol.noOverrides": "모든 모델이 프로바이더 와이어를 사용합니다.",
  "pws.protocol.overridesTruncated": "처음 {count}개 모델만 표시합니다.",
  "pws.protocol.col.model": "모델",
