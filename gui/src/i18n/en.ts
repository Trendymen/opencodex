...
export const en = {
  ...
  "onboarding.star.title": "Enjoying OpenCodex?",
  "onboarding.star.body": "OpenCodex is free and open source. A star on GitHub helps other developers find it and keeps the project going.",
  "onboarding.star.cta": "Star on GitHub",
  "onboarding.star.ghHint": "Stars the repository with your signed-in GitHub CLI (gh). Nothing is starred until you click.",
...
"common.discard": "Discard",
  ...
  "prov.removedShadowTarget": "Removed \"{name}\". Shadow Call Intercept still targets \"{model}\", so helper calls will fail until you choose another target.",
  ...
  "prov.disabledShadowTarget": "Disabled \"{name}\". Shadow Call Intercept still targets \"{model}\", so helper calls will fail until you choose another target or re-enable \"{name}\".",
  ...
  "models.subtitle": "Toggle which models Codex sees — native GPT passthrough and routed providers, grouped by provider (click a header to collapse). Hidden models stay off the catalog + model picker but remain directly callable by exact id.",
  "models.delivery.title": "How changes reach Codex",
  "models.delivery.chip.saved": "Saved here",
  "models.delivery.chip.savedHub": "Saved on hub",
  "models.delivery.chip.synced": "Synced {time}",
  "models.delivery.chip.syncedUnknown": "No sync recorded",
  "models.delivery.chip.loaded": "Codex loads it on restart",
  "models.delivery.saved.title": "Saved to this proxy",
  "models.delivery.saved.body": "Saving on this page rewrites the model catalog this OpenCodex proxy hands to Codex, which is the list the Codex model picker shows. The confirmation after saving means this step is done.",
  "models.delivery.savedHub.title": "Saved on the hub",
  "models.delivery.savedHub.body": "This machine is connected to a shared OpenCodex hub, so saving here changes the hub's catalog. The confirmation after saving means the hub has it; this machine still has to download it.",
  "models.delivery.synced.title": "Synced to this machine",
  "models.delivery.synced.bodyAt": "This machine last downloaded the hub catalog on {time} and wrote it where Codex reads it. That time only tells you when the download ran. If you saved on the hub after it, this machine keeps the previous list until the next sync.",
  "models.delivery.synced.bodyUnknown": "This machine has no recorded download of the hub catalog yet, so Codex may still be reading an older list. The next sync downloads it.",
  "models.delivery.loaded.title": "Loaded by Codex",
  "models.delivery.loaded.body": "Codex reads the catalog when it starts, so a Codex window that was already open keeps its old model list. OpenCodex cannot look inside a running Codex to see which list it uses. When it can tell that Codex started before your change, a restart notice appears above the tabs.",
  "models.delivery.hint": "If a model you turned on does not show up in Codex, press Reload Codex models at the top right of this page, then reopen Codex.",
  ...
  "models.settingsPanel.title": "Model settings",
  "models.settingsPanel.off": "off",
  "models.settingsPanel.attention": "Needs attention",
  ...
  "models.applied": "Saved. Codex shows the change after it reloads the model list.",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "logs.filter.protocol.label": "Protocol path",
  "logs.filter.protocol.all": "All paths",
  "logs.filter.protocol.none": "No path data",
  "logs.protocol.mode.native": "Native",
  "logs.protocol.mode.translated": "Translated",
  "logs.protocol.mode.legacyBridge": "Legacy bridge",
  "logs.protocol.mode.blocked": "Blocked",
  "logs.protocol.disposition.passthrough": "Passed through",
  "logs.protocol.disposition.translated": "Translated",
  "logs.protocol.disposition.degraded": "Degraded",
  "logs.protocol.disposition.unsupported": "Dropped",
  "logs.protocol.wire.responses": "Responses",
  "logs.protocol.wire.chat": "Chat",
  "logs.protocol.wire.messages": "Messages",
  "logs.protocol.wire.other": "Other adapter",
  "logs.protocol.hop.ir": "IR",
  "logs.protocol.hop.internal": "Responses (internal)",
  "logs.protocol.badgeTitle": "Protocol path: {path} ({mode})",
  "logs.detail.protocol.section": "Protocol path",
  "logs.detail.protocol.inbound": "Client API",
  "logs.detail.protocol.mode": "Delivery mode",
  "logs.detail.protocol.upstream": "Upstream wire",
  "logs.detail.protocol.requestPath": "Request path",
  "logs.detail.protocol.responsePath": "Response path",
  "logs.detail.protocol.reasons": "Reasons",
  "logs.detail.protocol.features": "Feature effects",
  "logs.detail.protocol.attempts": "Attempt paths",
  "logs.detail.protocol.attempt": "Attempt {ordinal}",
  "logs.detail.protocol.none": "No path data recorded for this request.",
  ...
  "logs.detail.attempt.recovery.oauthAccount429": "OAuth account rate-limited (429)",
  "logs.detail.attempt.recovery.image413": "Image payload too large (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "Opaque reasoning blob rejected",
  ...
  "debug.providerText": "Response/reasoning text (persisted)",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "codexAuth.mainHardLockEnabled": "98% protection is on.",
  "codexAuth.mainHardLockDisabled": "98% protection is off. Other account limits still apply.",
  ...
  "codexAuth.mainHardLockBlocked": "Blocked by 98% protection",
  ...
  "anthropicGrant.badgeAria": "{count} Claude usage reset(s)",
  "anthropicGrant.badgeErrorAria": "Claude usage resets could not be read",
  "anthropicGrant.title": "Claude usage resets",
  "anthropicGrant.available": "This account has {count} usage reset(s).",
  "anthropicGrant.desc": "A reset refills this account's 5-hour and weekly Claude limits right away. The weekly reset day stays the same.",
  "anthropicGrant.none": "This account has no usage resets.",
  "anthropicGrant.ineligible": "This account is not eligible for usage resets right now.",
  "anthropicGrant.loadFailed": "Could not read usage resets for this account.",
  "anthropicGrant.loadFailedAuth": "Sign in to this Anthropic account again to read its resets.",
  "anthropicGrant.retry": "Try again",
  "anthropicGrant.resetsLeft": "{left} of {total} left",
  "anthropicGrant.validFrom": "Valid from {date}",
  "anthropicGrant.expires": "Expires {date} ({days}d left)",
  "anthropicGrant.windowFiveHour": "5-hour {percent}%",
  "anthropicGrant.windowWeekly": "Weekly {percent}%",
  "anthropicGrant.windowOverage": "Extra {percent}%",
  "anthropicGrant.paused": "Paused",
  "anthropicGrant.notUsable": "Not usable yet",
  "anthropicGrant.requiresLimit": "Usable once this account hits a limit",
  "anthropicGrant.useOne": "Use 1 reset",
  "anthropicGrant.confirmTitle": "Reset usage limits now?",
  "anthropicGrant.confirmDesc": "This refills this account's Claude usage limits now and uses one reset.",
  "anthropicGrant.confirmWhich": "Uses: {label}",
  "anthropicGrant.irreversible": "This action cannot be undone.",
  "anthropicGrant.redeem": "Reset limits",
  "anthropicGrant.redeeming": "Resetting…",
  "anthropicGrant.resultReset": "Limits reset. {count} reset(s) left.",
  "anthropicGrant.resultAlreadyUsed": "This reset was already used.",
  "anthropicGrant.resultNotLimited": "This account is not at a limit, so nothing was used.",
  "anthropicGrant.resultCooldown": "Resets are cooling down for this account. Nothing was used.",
  "anthropicGrant.resultIneligible": "This account is no longer eligible. Nothing was used.",
  "anthropicGrant.resultUnavailable": "Resets are unavailable right now. Nothing was used.",
  "anthropicGrant.resultRateLimited": "Too many requests. Nothing was used; try again in a minute.",
  "anthropicGrant.resultAuthError": "Sign in to this Anthropic account again. Nothing was used.",
  "anthropicGrant.replayed": "This reset already settled earlier. Nothing was used again.",
  "anthropicGrant.notUsableNow": "This reset cannot be used right now. Re-read the account.",
  "anthropicGrant.inFlight": "This reset is still being processed. Wait a moment, then re-read the account.",
  "anthropicGrant.unresolvedPrior": "An earlier attempt on this reset is not confirmed yet. Retry that attempt instead of starting a new one.",
  "anthropicGrant.expired": "The earlier attempt could not be confirmed in time. Re-read the account before using a reset.",
  "anthropicGrant.identityMismatch": "That reset belongs to another account. Close this dialog and start again.",
  "anthropicGrant.sessionRequired": "Open the dashboard from its own login to use resets.",
  "anthropicGrant.journalBusy": "The reset journal is busy or unavailable. Nothing was used; try again in a moment.",
  "anthropicGrant.failed": "The reset request failed. Check the account before trying again.",
  "anthropicGrant.noOperationId": "This browser cannot generate a request ID, so resets are disabled here.",
  "anthropicGrant.unknownOutcome": "The reset did not answer in time, so its outcome is unknown. Retrying sends the same request ID, so it cannot start a second reset.",
  "anthropicGrant.retrySame": "Retry same request",
  "anthropicGrant.checkResult": "Re-read account",
  "anthropicGrant.checking": "Re-reading…",
  ...
  "api.surface.on": "On",
  "api.surface.off": "Off",
  "api.surface.source.fixed": "Always served",
  "api.surface.source.explicit": "Explicit setting",
  "api.surface.source.inherited": "Inherited from Claude settings",
  "api.surface.source.invalid": "Invalid value — closed",
  "api.surface.messagesToggle": "Serve the Messages API",
  "api.surface.messagesCloseNote": "Turning Messages off also turns off the Claude integration, so an older opencodex version keeps the endpoint closed too.",
  "api.surface.openClaude": "Claude settings",
  "api.surface.toggleFailed": "The Messages setting could not be saved.",
  "api.surface.toggleUnavailable": "This proxy version cannot change the Messages API here. Use the Claude page instead.",
  "api.surface.closedNote": "Requests to this endpoint are refused with 403.",
  ...
  "api.section.plan": "Path preview",
  "api.plan.title": "Request path preview",
  "api.plan.description": "Shows the path a request for this model would take through the proxy. A preview sends nothing upstream and costs nothing.",
  "api.plan.modeNote": "Native describes how a request is delivered. It is not a verification result.",
  "api.plan.unavailable": "This proxy version does not offer path previews.",
  "api.plan.noModels": "No models to preview yet.",
  "api.plan.model": "Model",
  "api.plan.inbound": "Client API",
  "api.plan.features": "Request features",
  "api.plan.preview": "Preview",
  "api.plan.previewing": "Previewing…",
  "api.plan.failed": "The preview could not be computed.",
  "api.plan.overallMode": "Delivery",
  "api.plan.routeKind": "Route",
  "api.plan.reasons": "Reasons",
  "api.plan.guaranteed": "Guaranteed by all candidates",
  "api.plan.partial": "Some candidates only",
  "api.plan.policyRevision": "Policy revision",
  "api.plan.noCandidates": "No route matches this model.",
  "api.plan.ineligible": "Refused under the current policy",
  "api.plan.requestPath": "Request path",
  "api.plan.responsePath": "Response path",
  "api.plan.fidelity": "Fidelity",
  "api.plan.none": "None",
  "api.plan.noPath": "No path",
  "api.plan.noFeatures": "No request features selected.",
  "api.plan.mode.native": "Native",
  "api.plan.mode.translated": "Translated",
  "api.plan.mode.legacyBridge": "Legacy bridge",
  "api.plan.mode.blocked": "Blocked",
  "api.plan.fidelity.preserved": "Preserved",
  "api.plan.fidelity.degraded": "Degraded",
  "api.plan.fidelity.unknown": "Unknown",
  "api.plan.routeKind.direct": "Direct",
  "api.plan.routeKind.combo": "Combo",
  "api.plan.routeKind.policy": "Routing policy",
  "api.plan.routeKind.unknown": "Unknown model",
  "api.plan.disposition.passthrough": "Passed through",
  "api.plan.disposition.translated": "Translated",
  "api.plan.disposition.degraded": "Degraded",
  "api.plan.disposition.unsupported": "Dropped",
  "api.plan.disposition.unknown": "Unknown",
  ...
  "cws.jev.create": "Create JEV Auto",
  ...
  "cws.jev.effortsNone": "No explicit reasoning effort",
  "cws.jev.stats.tab": "Stats",
  "cws.jev.stats.range": "JEV stats range",
  "cws.jev.stats.refresh": "Refresh",
  "cws.jev.stats.loading": "Loading JEV stats",
  "cws.jev.stats.loadFailed": "JEV stats could not be loaded.",
  "cws.jev.stats.historyIncomplete": "Some older JEV records were omitted, so these totals may be incomplete.",
  "cws.jev.stats.emptyTitle": "No JEV decisions yet",
  "cws.jev.stats.emptyBody": "Run this combo to record picks and model token usage. Decisions made before stats support was installed are unavailable.",
  "cws.jev.stats.decisions": "Decisions",
  "cws.jev.stats.appliedAndFailOpen": "{applied} applied · {failOpen} fail-open",
  "cws.jev.stats.modelTokens": "Model tokens",
  "cws.jev.stats.decisionTokens": "JEV decision tokens",
  "cws.jev.stats.measuredAttempts": "{measured}/{total} attempts measured",
  "cws.jev.stats.measuredDecisions": "{measured}/{total} decisions reported usage",
  "cws.jev.stats.successful": "{count} successful requests",
  "cws.jev.stats.fallbackOne": "{count} model fallback",
  "cws.jev.stats.fallbackMany": "{count} model fallbacks",
  "cws.jev.stats.averageLatency": "Average JEV latency: {value}",
  "cws.jev.stats.averageConfidence": "Average confidence: {value}",
  "cws.jev.stats.gates": "JEV decision gates",
  "cws.jev.stats.model": "Model",
  "cws.jev.stats.otherModels": "Other models",
  "cws.jev.stats.picks": "Picks",
  "cws.jev.stats.efforts": "Efforts",
  "cws.jev.stats.attempts": "Attempts",
  "cws.jev.stats.input": "Input",
  "cws.jev.stats.output": "Output",
  "cws.jev.stats.reasoning": "Reasoning",
  "cws.jev.stats.cacheReadWrite": "Cache R/W",
  "cws.jev.stats.total": "Total",
  "cws.jev.stats.noEffort": "none",
  "cws.jev.stats.measuredShort": "measured",
  "cws.jev.stats.tokenFootnote": "Model tokens come from physical target attempts, including retries and fallbacks. JEV decision tokens are reported separately by the decision service.",
  ...
  "cws.strategy.jevHint": "Ask TypeSafe JEV to choose one eligible target and compatible effort. If the decision is unavailable, use the first eligible target.",
  ...
  "cws.targets.jevHint": "Only these targets can be selected. Order determines the fail-open target and later Combo fallback.",
  ...
  "cws.err.invalidReasoningEfforts": "Each JEV target must allow at least one unique supported reasoning effort.",
  ...
  "claudeDesktop.picker.title": "Claude Desktop picker",
  "claudeDesktop.picker.hint": "Show OpenCodex models in Desktop's Code tab picker through the dedicated local proxy.",
  "claudeDesktop.picker.toggle": "Enable Claude Desktop picker",
  "claudeDesktop.picker.state.active": "Picker is active",
  "claudeDesktop.picker.state.restart": "Fully quit and reopen Claude Desktop to finish applying the picker profile.",
  "claudeDesktop.picker.state.trustPending": "Waiting for the keychain step",
  "claudeDesktop.picker.state.trustDeclined": "Keychain trust was declined",
  "claudeDesktop.picker.state.proxyUnavailable": "Picker proxy is not running",
  "claudeDesktop.picker.state.unsupported": "Picker mode is unsupported on this OS",
  "claudeDesktop.picker.state.notFirstParty": "Picker is available only in first-party mode",
  "claudeDesktop.picker.state.profileFailed": "The picker profile could not be applied",
  "claudeDesktop.picker.models": "{count} models available in the picker",
  "claudeDesktop.picker.offlineNote": "While picker mode is on, Claude Desktop reaches the network through OpenCodex. If OpenCodex stops, Desktop is offline until it restarts or picker mode is turned off.",
  "claudeDesktop.firstParty.bindings.title": "Code tab model bindings",
  "claudeDesktop.firstParty.bindings.hint": "Claude Desktop keeps Anthropic's names in the Code tab picker. Bind a picker model to an OpenCodex model and requests for that picker entry are served by the bound model. Only Claude Code traffic through the local proxy (the Desktop Code tab and the claude CLI) uses these bindings; ocx claude is unaffected. Bindings apply on the next request — no need to fully quit and reopen.",
  "claudeDesktop.firstParty.bindings.empty": "No bindings yet — picker models follow their default route.",
  "claudeDesktop.firstParty.bindings.pickerLabel": "Picker model id",
  "claudeDesktop.firstParty.bindings.pickerPlaceholder": "claude-sonnet-4-6",
  "claudeDesktop.firstParty.bindings.routeLabel": "OpenCodex model",
  "claudeDesktop.firstParty.bindings.routePlaceholder": "Choose a model",
  "claudeDesktop.firstParty.bindings.add": "Add binding",
  "claudeDesktop.firstParty.bindings.remove": "Remove binding {id}",
  "claudeDesktop.firstParty.bindings.saveFailed": "Could not save model bindings",
  ...
  "link.switchOffHint": "Turn on linking to choose this computer's role.",
  "link.role.title": "Choose this computer's role",
  "link.role.hint": "Home shares this computer's providers with Child computers. Child connects this computer to a Home when this computer runs standalone.",
  "link.role.home": "Home",
  ...
  "link.confirming": "Confirming…",
  "link.confirm": "Confirm host",
  ...
  "link.close": "Close",
  "link.cancel": "Cancel",
  "remoteLink.childDisabled": "Child links can only be started from a standalone runtime.",
  "remoteLink.findHome.title": "Find Home",
  ...
  "remoteLink.restart.waiting": "Waiting for this computer to reconnect as Child…",
  "remoteLink.error.standalone_required": "Child links can only be started from a standalone runtime.",
  "remoteLink.error.join_tunnel_failed": "The tunnel to Home could not be started. Check SSH access and retry.",
  "remoteLink.error.admission_failed": "Home did not accept the new link. Check that it is running and retry.",
  "remoteLink.error.join_issue_failed": "Home could not issue a link. Check that OpenCodex is running on Home and retry.",
  ...
  "link.noChildren": "No child computers are connected.",
  "remoteLink.status.connecting": "Connecting",
  "remoteLink.status.connected": "Connected",
  "remoteLink.status.reconnecting": "Reconnecting",
  "remoteLink.status.failed": "Connection needs attention",
  "remoteLink.status.idle": "Idle",
  "remoteLink.role.standalone": "Standalone",
  "remoteLink.role.home": "Home",
  "remoteLink.role.child": "Child",
  "remoteLink.direction.hub": "Hub initiated",
  "remoteLink.direction.client": "Client initiated",
  "remoteLink.error.admission_timeout": "Remote link request could not be completed.",
  "remoteLink.error.compensation_failed": "Remote link request could not be completed.",
  "remoteLink.error.fingerprint_failed": "Remote link request could not be completed.",
  "remoteLink.error.forbidden": "Remote link request could not be completed.",
  "remoteLink.error.host_confirmation_expired": "Remote link request could not be completed.",
  "remoteLink.error.host_fingerprint_mismatch": "Remote link request could not be completed.",
  "remoteLink.error.host_not_confirmed": "Remote link request could not be completed.",
  "remoteLink.error.invalid_alias": "Remote link request could not be completed.",
  "remoteLink.error.invalid_body": "Remote link request could not be completed.",
  "remoteLink.error.invalid_link_id": "Remote link request could not be completed.",
  "remoteLink.error.key_issue_failed": "Remote link request could not be completed.",
  "remoteLink.error.key_revoke_failed": "Remote link request could not be completed.",
  "remoteLink.error.link_apply_failed": "Remote link request could not be completed.",
  "remoteLink.error.link_exists": "Remote link request could not be completed.",
  "remoteLink.error.link_not_found": "Remote link request could not be completed.",
  "remoteLink.error.link_remove_failed": "Remote link request could not be completed.",
  "remoteLink.error.link_unavailable": "Remote link request could not be completed.",
  "remoteLink.error.listener_unavailable": "Remote link request could not be completed.",
  "remoteLink.error.probe_failed": "Remote link request could not be completed.",
  "remoteLink.error.remote_connect_failed": "Remote link request could not be completed.",
  "remoteLink.error.remote_disconnect_failed": "Remote link request could not be completed.",
  "remoteLink.error.remote_port_failed": "Remote link request could not be completed.",
  "remoteLink.error.tailscale_session_refused": "Remote link request could not be completed.",
  "remoteLink.error.version_probe_failed": "Remote link request could not be completed.",
  "remoteLink.error.generic": "Remote link request could not be completed.",
  "remoteLink.reason.auth": "Authentication failed.",
  "remoteLink.reason.hostkey": "The host key could not be verified.",
  "remoteLink.reason.forward": "Port forwarding failed.",
  "remoteLink.reason.timeout": "The connection timed out.",
  "remoteLink.reason.bind": "The local port could not be bound.",
  "remoteLink.reason.persist": "The link state could not be saved.",
  "remoteLink.reason.compensation_failed": "Cleanup after linking failed.",
  "remoteLink.reason.staleTunnel": "A stale tunnel may still hold the port.",
  "remoteLink.reason.generic": "Reason:",
  "remoteLink.workspaceMoved.title": "Remote Workspace has its own page now",
  "remoteLink.workspaceMoved.body": "Use the separate Remote Workspace page.",
  "remoteLink.workspaceMoved.open": "Open Remote Workspace",
  "remoteLink.forceRemove.title": "This machine could not reach {alias}",
  "remoteLink.forceRemove.body": "Remove the link only on this machine? Afterwards run {cmd} on {alias} yourself.",
  ...
  "quotaSummary.scrollPrev": "Scroll providers left",
  "quotaSummary.scrollNext": "Scroll providers right",
  "quotaSummary.openAccounts": "Open account management",
